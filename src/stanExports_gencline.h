...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gencline");
    reader.add_event(73, 71, "end", "model_gencline");
    return reader;
}
...
class model_gencline
  : public stan::model::model_base_crtp<model_gencline> {
private:
        int L;
        int N;
        ...
        vector_d P1;
public:
    model_gencline(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gencline_namespace::model_gencline";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.vector_lub_unconstrain(0.01, 100, v);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                v = in__.vector_lub_constrain(0.01, 100, L, lp__);
            else
                v = in__.vector_lub_constrain(0.01, 100, L);
            current_statement_begin__ = 35;
            local_scalar_t__ sc;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gencline_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> v = in__.vector_lub_constrain(0.01, 100, L);
        size_t v_j_1_max__ = L;
        for (size_t j_1__ = 0; j_1__ < v_j_1_max__; ++j_1__) {
...
typedef model_gencline_namespace::model_gencline stan_model;
#ifndef USING_R
