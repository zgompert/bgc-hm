...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gencline_one_gl_mix");
    reader.add_event(61, 59, "end", "model_gencline_one_gl_mix");
    return reader;
}
...
class model_gencline_one_gl_mix
  : public stan::model::model_base_crtp<model_gencline_one_gl_mix> {
private:
        int L;
        int N;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int j = 1; j <= N; ++j) {
                ...
                lp_accum__.add(calc_lik(get_base1(GL0, j, "GL0", 1), get_base1(GL1, j, "GL1", 1), get_base1(GL2, j, "GL2", 1), P0, P1, get_base1(H, j, "H", 1), v, u, get_base1(ploidy, j, "ploidy", 1), pstream__));
            }
...
typedef model_gencline_one_gl_mix_namespace::model_gencline_one_gl_mix stan_model;
#ifndef USING_R
