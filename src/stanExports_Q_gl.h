...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Q_gl");
    reader.add_event(48, 46, "end", "model_Q_gl");
    return reader;
}
...
calc_lik(const T0__& gl0,
             ...
             const T5__& q11,
             const T6__& q10,
             const T7__& q00, std::ostream* pstream__) {
...
struct calc_lik_functor__ {
    ...
    operator()(const T0__& gl0,
             ...
             const T5__& q11,
             const T6__& q10,
             const T7__& q00, std::ostream* pstream__) const {
        return calc_lik(gl0, gl1, gl2, p0, p1, q11, q10, q00, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_Q_gl
  : public stan::model::model_base_crtp<model_Q_gl> {
private:
        int L;
        int N;
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N; ++j) {
                    ...
                    lp_accum__.add(calc_lik(get_base1(get_base1(GL0, j, "GL0", 1), i, "GL0", 2), get_base1(get_base1(GL1, j, "GL1", 1), i, "GL1", 2), get_base1(get_base1(GL2, j, "GL2", 1), i, "GL2", 2), get_base1(P0, i, "P0", 1), get_base1(P1, i, "P1", 1), get_base1(get_base1(Q, j, "Q", 1), 1, "Q", 2), get_base1(get_base1(Q, j, "Q", 1), 2, "Q", 2), get_base1(get_base1(Q, j, "Q", 1), 3, "Q", 2), pstream__));
                }
            }
...
typedef model_Q_gl_namespace::model_Q_gl stan_model;
#ifndef USING_R
