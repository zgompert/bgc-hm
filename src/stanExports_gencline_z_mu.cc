...
#include "stanExports_gencline_z_mu.h"

RCPP_MODULE(stan_fit4gencline_z_mu_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_gencline_z_mu")
