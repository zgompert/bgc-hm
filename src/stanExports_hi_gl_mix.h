...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'hi_gl_mix', line 26, column 1 to column 31)",
                                                      " (in 'hi_gl_mix', line 32, column 3 to column 85)",
                                                      " (in 'hi_gl_mix', line 30, column 15 to line 33, column 3)",
                                                      " (in 'hi_gl_mix', line 30, column 2 to line 33, column 3)",
                                                      " (in 'hi_gl_mix', line 29, column 14 to line 34, column 2)",
                                                      " (in 'hi_gl_mix', line 29, column 1 to line 34, column 2)",
                                                      " (in 'hi_gl_mix', line 37, column 2 to column 39)",
                                                      " (in 'hi_gl_mix', line 35, column 14 to line 38, column 2)",
                                                      " (in 'hi_gl_mix', line 35, column 1 to line 38, column 2)",
                                                      " (in 'hi_gl_mix', line 16, column 1 to column 7)",
                                                      " (in 'hi_gl_mix', line 17, column 1 to column 7)",
                                                      " (in 'hi_gl_mix', line 18, column 28 to column 29)",
                                                      " (in 'hi_gl_mix', line 18, column 31 to column 32)",
                                                      " (in 'hi_gl_mix', line 18, column 1 to column 34)",
                                                      " (in 'hi_gl_mix', line 19, column 28 to column 29)",
                                                      " (in 'hi_gl_mix', line 19, column 31 to column 32)",
                                                      " (in 'hi_gl_mix', line 19, column 1 to column 34)",
                                                      ...
                                                      " (in 'hi_gl_mix', line 21, column 34 to column 35)",
                                                      " (in 'hi_gl_mix', line 21, column 1 to column 37)",
                                                      " (in 'hi_gl_mix', line 22, column 26 to column 27)",
                                                      " (in 'hi_gl_mix', line 22, column 1 to column 32)",
                                                      " (in 'hi_gl_mix', line 23, column 26 to column 27)",
                                                      " (in 'hi_gl_mix', line 23, column 1 to column 32)",
                                                      " (in 'hi_gl_mix', line 26, column 26 to column 27)",
                                                      ...
                                                      " (in 'hi_gl_mix', line 8, column 11 to line 11, column 6)",
                                                      ...
                                                      " (in 'hi_gl_mix', line 4, column 2 to line 11, column 6)",
                                                      " (in 'hi_gl_mix', line 12, column 2 to column 14)",
                                                      " (in 'hi_gl_mix', line 2, column 79 to line 13, column 2)"};
...
calc_lik(const T0__& gl0, const T1__& gl1, const T2__& gl2, const T3__& p0,
         const T4__& p1, const T5__& h, const T6__& pl,
...
{
return calc_lik(gl0, gl1, gl2, p0, p1, h, pl, pstream__);
}
};
...
public:
  ...
  inline std::string model_name() const final { return "model_hi_gl_mix"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_hi_gl_mix(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_hi_gl_mix_namespace::model_hi_gl_mix";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_hi_gl_mix_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_hi_gl_mix_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
