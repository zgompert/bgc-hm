...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gencline_sdk_z");
    reader.add_event(58, 56, "end", "model_gencline_sdk_z");
    return reader;
}
...
class model_gencline_sdk_z
  : public stan::model::model_base_crtp<model_gencline_sdk_z> {
private:
        int L;
        int N;
...
typedef model_gencline_sdk_z_namespace::model_gencline_sdk_z stan_model;
#ifndef USING_R
