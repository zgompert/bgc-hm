...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gencline_sdk_z_mix");
    reader.add_event(68, 66, "end", "model_gencline_sdk_z_mix");
    return reader;
}
...
class model_gencline_sdk_z_mix
  : public stan::model::model_base_crtp<model_gencline_sdk_z_mix> {
private:
        int L;
        int N;
...
typedef model_gencline_sdk_z_mix_namespace::model_gencline_sdk_z_mix stan_model;
#ifndef USING_R
