...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_hi_mix");
    reader.add_event(49, 47, "end", "model_hi_mix");
    return reader;
}
    ...
    try {
        ...
        if (as_bool(logical_eq(pl, 2))) {
            ...
            if (as_bool(logical_eq(g, 0))) {
                ...
                stan::math::assign(prob, stan::math::log(((h * (1 - p1)) + ((1 - h) * (1 - p0)))));
            } else {
                current_statement_begin__ = 15;
                stan::math::assign(prob, stan::math::log(((h * p1) + ((1 - h) * p0))));
            }
        }
...
class model_hi_mix
  : public stan::model::model_base_crtp<model_hi_mix> {
private:
        int L;
        int N;
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N; ++j) {
                    ...
                    lp_accum__.add(calc_lik(get_base1(get_base1(G, j, "G", 1), i, "G", 2), get_base1(P0, i, "P0", 1), get_base1(P1, i, "P1", 1), get_base1(H, j, "H", 1), get_base1(get_base1(ploidy, j, "ploidy", 1), i, "ploidy", 2), pstream__));
                }
            }
...
typedef model_hi_mix_namespace::model_hi_mix stan_model;
#ifndef USING_R
