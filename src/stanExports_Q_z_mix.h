...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Q_z_mix");
    reader.add_event(58, 56, "end", "model_Q_z_mix");
    return reader;
}
    ...
    try {
        ...
        if (as_bool(logical_eq(pl, 2))) {
            ...
            if (as_bool(logical_eq(z, 0))) {
                ...
                stan::math::assign(prob, stan::math::log(q00));
            } else if (as_bool(logical_eq(z, 1))) {
                current_statement_begin__ = 8;
                stan::math::assign(prob, stan::math::log(q10));
            } else {
                current_statement_begin__ = 10;
                stan::math::assign(prob, stan::math::log(q11));
            }
            current_statement_begin__ = 11;
            return stan::math::promote_scalar<fun_return_scalar_t__>(prob);
        } else if (as_bool(logical_eq(pl, 0))) {
            current_statement_begin__ = 13;
            if (as_bool(logical_eq(z, 0))) {
                current_statement_begin__ = 14;
                stan::math::assign(prob, (stan::math::log(q00) + (0.5 * stan::math::log(q10))));
            } else {
                current_statement_begin__ = 16;
                stan::math::assign(prob, (stan::math::log(q11) + (0.5 * stan::math::log(q10))));
            }
        } else {
...
class model_Q_z_mix
  : public stan::model::model_base_crtp<model_Q_z_mix> {
private:
        int L;
        int N;
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N; ++j) {
                    ...
                    lp_accum__.add(calc_lik(get_base1(get_base1(Z, j, "Z", 1), i, "Z", 2), get_base1(get_base1(Q, j, "Q", 1), 1, "Q", 2), get_base1(get_base1(Q, j, "Q", 1), 2, "Q", 2), get_base1(get_base1(Q, j, "Q", 1), 3, "Q", 2), get_base1(get_base1(ploidy, j, "ploidy", 1), i, "ploidy", 2), pstream__));
                }
            }
...
typedef model_Q_z_mix_namespace::model_Q_z_mix stan_model;
#ifndef USING_R
