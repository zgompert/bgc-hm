...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Q");
    reader.add_event(50, 48, "end", "model_Q");
    return reader;
}
...
calc_lik(const T0__& g,
             ...
             const T3__& q11,
             const T4__& q10,
             const T5__& q00, std::ostream* pstream__) {
...
struct calc_lik_functor__ {
    ...
    operator()(const T0__& g,
             ...
             const T3__& q11,
             const T4__& q10,
             const T5__& q00, std::ostream* pstream__) const {
        return calc_lik(g, p0, p1, q11, q10, q00, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_Q
  : public stan::model::model_base_crtp<model_Q> {
private:
        int L;
        int N;
        ...
        vector_d P1;
public:
    model_Q(stan::io::var_context& context__,
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N; ++j) {
                    ...
                    lp_accum__.add(calc_lik(get_base1(get_base1(G, j, "G", 1), i, "G", 2), get_base1(P0, i, "P0", 1), get_base1(P1, i, "P1", 1), get_base1(get_base1(Q, j, "Q", 1), 1, "Q", 2), get_base1(get_base1(Q, j, "Q", 1), 2, "Q", 2), get_base1(get_base1(Q, j, "Q", 1), 3, "Q", 2), pstream__));
                }
            }
...
typedef model_Q_namespace::model_Q stan_model;
#ifndef USING_R
