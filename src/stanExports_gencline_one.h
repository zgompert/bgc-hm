...
namespace model_gencline_one_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'gencline_one', line 31, column 1 to column 38)",
                                                      " (in 'gencline_one', line 32, column 1 to column 28)",
                                                      " (in 'gencline_one', line 35, column 1 to column 31)",
                                                      " (in 'gencline_one', line 36, column 1 to column 23)",
                                                      " (in 'gencline_one', line 41, column 2 to column 47)",
                                                      " (in 'gencline_one', line 39, column 14 to line 42, column 2)",
                                                      " (in 'gencline_one', line 39, column 1 to line 42, column 2)",
                                                      " (in 'gencline_one', line 44, column 1 to column 46)",
                                                      " (in 'gencline_one', line 45, column 1 to column 41)",
                                                      " (in 'gencline_one', line 21, column 1 to column 7)",
                                                      " (in 'gencline_one', line 22, column 1 to column 7)",
                                                      " (in 'gencline_one', line 23, column 26 to column 27)",
                                                      " (in 'gencline_one', line 23, column 1 to column 29)",
                                                      " (in 'gencline_one', line 24, column 26 to column 27)",
                                                      " (in 'gencline_one', line 24, column 1 to column 31)",
                                                      " (in 'gencline_one', line 25, column 1 to column 27)",
                                                      " (in 'gencline_one', line 26, column 1 to column 27)",
                                                      " (in 'gencline_one', line 27, column 1 to column 18)",
                                                      " (in 'gencline_one', line 28, column 1 to column 18)",
                                                      " (in 'gencline_one', line 3, column 2 to column 11)",
                                                      " (in 'gencline_one', line 4, column 2 to column 43)",
                                                      " (in 'gencline_one', line 5, column 2 to column 13)",
                                                      " (in 'gencline_one', line 2, column 40 to line 6, column 2)",
                                                      " (in 'gencline_one', line 8, column 2 to column 12)",
                                                      " (in 'gencline_one', line 9, column 2 to column 11)",
                                                      " (in 'gencline_one', line 10, column 2 to column 28)",
                                                      " (in 'gencline_one', line 16, column 24 to column 91)",
                                                      " (in 'gencline_one', line 14, column 24 to column 99)",
                                                      " (in 'gencline_one', line 13, column 21 to line 16, column 91)",
                                                      " (in 'gencline_one', line 12, column 24 to column 107)",
                                                      " (in 'gencline_one', line 11, column 16 to line 16, column 91)",
                                                      " (in 'gencline_one', line 17, column 2 to column 14)",
                                                      " (in 'gencline_one', line 7, column 66 to line 18, column 2)"};
...
class model_gencline_one final : public model_base_crtp<model_gencline_one> {
private:
  int L;
  int N;
  std::vector<double> G;
...
public:
  ...
  inline std::string model_name() const final { return "model_gencline_one"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_gencline_one(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_gencline_one_namespace::model_gencline_one";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_gencline_one_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      check_less_or_equal(function__, "u", u, 100);
      {
        ...
        for (int j = 1; j <= N; ++j) {
          ...
          lp_accum__.add(
            calc_lik(G[(j - 1)], P0, P1, H[(j - 1)], v, u, pstream__));}
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_gencline_one_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_gencline_one_namespace::model_gencline_one;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_gencline_one_namespace::profiles__;
}
#endif
#endif
