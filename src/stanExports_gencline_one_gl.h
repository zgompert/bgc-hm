...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'gencline_one_gl', line 21, column 28 to column 29)",
                                                      " (in 'gencline_one_gl', line 21, column 1 to column 31)",
                                                      " (in 'gencline_one_gl', line 22, column 28 to column 29)",
                                                      " (in 'gencline_one_gl', line 22, column 1 to column 31)",
                                                      " (in 'gencline_one_gl', line 23, column 28 to column 29)",
                                                      " (in 'gencline_one_gl', line 23, column 1 to column 31)",
...
public:
  ...
  inline std::string model_name() const final { return "model_gencline_one_gl"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_gencline_one_gl(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_gencline_one_gl_namespace::model_gencline_one_gl";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_gencline_one_gl_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_gencline_one_gl_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
