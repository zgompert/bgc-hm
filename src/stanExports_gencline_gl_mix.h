...
calc_lik(const T0__& gl0,
    ...
    try {
        ...
        if (as_bool(logical_eq(pl, 2))) {
            ...
            stan::math::assign(prob, (prob + ((stan::math::log(gl1) + stan::math::log(((phi * (1 - p1)) + ((1 - phi) * (1 - p0))))) + stan::math::log(((phi * p1) + ((1 - phi) * p0))))));
            current_statement_begin__ = 15;
            stan::math::assign(prob, (prob + ((stan::math::log(gl2) + stan::math::log(((phi * p1) + ((1 - phi) * p0)))) + stan::math::log(((phi * p1) + ((1 - phi) * p0))))));
        } else {
            current_statement_begin__ = 17;
            stan::math::assign(prob, (stan::math::log(gl0) + stan::math::log(((phi * (1 - p1)) + ((1 - phi) * (1 - p0))))));
            current_statement_begin__ = 19;
            stan::math::assign(prob, (prob + (stan::math::log(gl2) + stan::math::log(((phi * p1) + ((1 - phi) * p0))))));
        }
