...
namespace model_gencline_gl_mix_mu_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 73> locations_array__ =
  {" (found before start of program)",
  " (in 'gencline_gl_mix_mu', line 40, column 1 to column 43)",
  " (in 'gencline_gl_mix_mu', line 41, column 1 to column 33)",
  " (in 'gencline_gl_mix_mu', line 42, column 1 to column 18)",
  " (in 'gencline_gl_mix_mu', line 43, column 1 to column 18)",
  " (in 'gencline_gl_mix_mu', line 44, column 8 to column 26)",
  " (in 'gencline_gl_mix_mu', line 45, column 8 to column 26)",
  " (in 'gencline_gl_mix_mu', line 48, column 1 to column 36)",
  " (in 'gencline_gl_mix_mu', line 73, column 1 to column 19)",
  " (in 'gencline_gl_mix_mu', line 74, column 1 to column 19)",
  " (in 'gencline_gl_mix_mu', line 50, column 2 to column 33)",
  " (in 'gencline_gl_mix_mu', line 49, column 14 to line 51, column 2)",
  " (in 'gencline_gl_mix_mu', line 49, column 1 to line 51, column 2)",
  " (in 'gencline_gl_mix_mu', line 75, column 1 to column 25)",
  " (in 'gencline_gl_mix_mu', line 76, column 1 to column 20)",
  " (in 'gencline_gl_mix_mu', line 57, column 3 to column 97)",
  " (in 'gencline_gl_mix_mu', line 55, column 15 to line 58, column 3)",
  " (in 'gencline_gl_mix_mu', line 55, column 2 to line 58, column 3)",
  " (in 'gencline_gl_mix_mu', line 54, column 14 to line 59, column 2)",
  " (in 'gencline_gl_mix_mu', line 54, column 1 to line 59, column 2)",
  " (in 'gencline_gl_mix_mu', line 62, column 2 to column 52)",
  " (in 'gencline_gl_mix_mu', line 63, column 2 to column 47)",
  " (in 'gencline_gl_mix_mu', line 60, column 16 to line 64, column 2)",
  " (in 'gencline_gl_mix_mu', line 60, column 1 to line 64, column 2)",
  " (in 'gencline_gl_mix_mu', line 66, column 1 to column 36)",
  " (in 'gencline_gl_mix_mu', line 67, column 1 to column 36)",
  " (in 'gencline_gl_mix_mu', line 69, column 8 to column 44)",
  " (in 'gencline_gl_mix_mu', line 70, column 8 to column 44)",
  " (in 'gencline_gl_mix_mu', line 27, column 1 to column 7)",
  " (in 'gencline_gl_mix_mu', line 28, column 1 to column 7)",
  " (in 'gencline_gl_mix_mu', line 29, column 28 to column 29)",
  " (in 'gencline_gl_mix_mu', line 29, column 31 to column 32)",
  " (in 'gencline_gl_mix_mu', line 29, column 1 to column 34)",
  " (in 'gencline_gl_mix_mu', line 30, column 28 to column 29)",
  " (in 'gencline_gl_mix_mu', line 30, column 31 to column 32)",
  " (in 'gencline_gl_mix_mu', line 30, column 1 to column 34)",
  " (in 'gencline_gl_mix_mu', line 31, column 28 to column 29)",
  " (in 'gencline_gl_mix_mu', line 31, column 31 to column 32)",
  " (in 'gencline_gl_mix_mu', line 31, column 1 to column 34)",
  " (in 'gencline_gl_mix_mu', line 32, column 31 to column 32)",
  " (in 'gencline_gl_mix_mu', line 32, column 34 to column 35)",
  " (in 'gencline_gl_mix_mu', line 32, column 1 to column 37)",
  " (in 'gencline_gl_mix_mu', line 33, column 26 to column 27)",
  " (in 'gencline_gl_mix_mu', line 33, column 1 to column 31)",
  " (in 'gencline_gl_mix_mu', line 34, column 26 to column 27)",
  " (in 'gencline_gl_mix_mu', line 34, column 1 to column 32)",
  " (in 'gencline_gl_mix_mu', line 35, column 26 to column 27)",
  " (in 'gencline_gl_mix_mu', line 35, column 1 to column 32)",
  " (in 'gencline_gl_mix_mu', line 36, column 8 to column 26)",
  " (in 'gencline_gl_mix_mu', line 37, column 8 to column 26)",
  " (in 'gencline_gl_mix_mu', line 40, column 33 to column 34)",
  " (in 'gencline_gl_mix_mu', line 41, column 28 to column 29)",
  " (in 'gencline_gl_mix_mu', line 48, column 31 to column 32)",
  " (in 'gencline_gl_mix_mu', line 3, column 2 to column 11)",
  " (in 'gencline_gl_mix_mu', line 4, column 2 to column 43)",
  " (in 'gencline_gl_mix_mu', line 5, column 2 to column 13)",
  " (in 'gencline_gl_mix_mu', line 2, column 40 to line 6, column 2)",
  " (in 'gencline_gl_mix_mu', line 9, column 2 to column 12)",
  " (in 'gencline_gl_mix_mu', line 10, column 2 to column 11)",
  " (in 'gencline_gl_mix_mu', line 11, column 2 to column 28)",
  " (in 'gencline_gl_mix_mu', line 21, column 3 to column 10)",
  " (in 'gencline_gl_mix_mu', line 20, column 8 to line 22, column 3)",
  " (in 'gencline_gl_mix_mu', line 17, column 6 to column 61)",
  " (in 'gencline_gl_mix_mu', line 19, column 17 to column 83)",
  " (in 'gencline_gl_mix_mu', line 16, column 18 to line 20, column 3)",
  " (in 'gencline_gl_mix_mu', line 16, column 9 to line 22, column 3)",
  " (in 'gencline_gl_mix_mu', line 13, column 13 to column 107)",
  " (in 'gencline_gl_mix_mu', line 14, column 13 to column 127)",
  " (in 'gencline_gl_mix_mu', line 15, column 13 to column 110)",
  " (in 'gencline_gl_mix_mu', line 12, column 11 to line 16, column 3)",
  " (in 'gencline_gl_mix_mu', line 12, column 2 to line 22, column 3)",
  " (in 'gencline_gl_mix_mu', line 23, column 2 to column 14)",
  " (in 'gencline_gl_mix_mu', line 8, column 97 to line 24, column 2)"};
...
class model_gencline_gl_mix_mu final : public model_base_crtp<model_gencline_gl_mix_mu> {
private:
  int L;
  int N;
...
public:
  ~model_gencline_gl_mix_mu() {}
  model_gencline_gl_mix_mu(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_gencline_gl_mix_mu_namespace::model_gencline_gl_mix_mu";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
    ...
    try {
      ...
      context__.validate_dims("data initialization", "sd0", "double",
        std::vector<size_t>{});
      sd0 = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 48;
      sd0 = context__.vals_r("sd0")[(1 - 1)];
      current_statement__ = 48;
      stan::math::check_greater_or_equal(function__, "sd0", sd0, 0);
    ...
    num_params_r__ = L + L + 1 + 1 + 1 + 1;
  }
  inline std::string model_name() const final {
    return "model_gencline_gl_mix_mu";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_gencline_gl_mix_mu_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      v = in__.template read_constrain_lub<
            ...
            L);
      local_scalar_t__ sc = DUMMY_VAR__;
      current_statement__ = 3;
      sc = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(0,
             lp__);
      local_scalar_t__ sv = DUMMY_VAR__;
      current_statement__ = 4;
      sv = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(0,
             lp__);
      local_scalar_t__ muc = DUMMY_VAR__;
      current_statement__ = 5;
      muc = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(0,
              lp__);
      local_scalar_t__ muv = DUMMY_VAR__;
      current_statement__ = 6;
      muv = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(0,
              lp__);
          ...
          lp_accum__.add(stan::math::normal_lpdf<false>(
                           stan::math::logit(
                             stan::model::rvalue(center, "center",
                               stan::model::index_uni(i))), muc, sc));
          current_statement__ = 21;
          lp_accum__.add(stan::math::normal_lpdf<false>(
                           stan::math::log10(
                             stan::model::rvalue(v, "v",
                               stan::model::index_uni(i))), muv, sv));
        }
        current_statement__ = 24;
        lp_accum__.add(stan::math::normal_lpdf<false>(sc, 0, sd0));
        current_statement__ = 25;
        lp_accum__.add(stan::math::normal_lpdf<false>(sv, 0, sd0));
        current_statement__ = 26;
        lp_accum__.add(stan::math::normal_lpdf<false>(muc, 0, mu0));
        current_statement__ = 27;
        lp_accum__.add(stan::math::normal_lpdf<false>(muv, 0, mu0));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_gencline_gl_mix_mu_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      sv = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(0,
             lp__);
      double muc = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 5;
      muc = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(0,
              lp__);
      double muv = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 6;
      muv = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(0,
              lp__);
      ...
      double sdc = std::numeric_limits<double>::quiet_NaN();
      double sdv = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 13;
      sdc = stan::math::sd(stan::math::logit(center));
      current_statement__ = 14;
      sdv = stan::math::sd(stan::math::log10(v));
      current_statement__ = 8;
      stan::math::check_greater_or_equal(function__, "sdc", sdc, 0);
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      local_scalar_t__ sc = DUMMY_VAR__;
      current_statement__ = 3;
      sc = in__.read<local_scalar_t__>();
      out__.write_free_lb(0, sc);
      local_scalar_t__ sv = DUMMY_VAR__;
      current_statement__ = 4;
      sv = in__.read<local_scalar_t__>();
      out__.write_free_lb(0, sv);
      local_scalar_t__ muc = DUMMY_VAR__;
      current_statement__ = 5;
      muc = in__.read<local_scalar_t__>();
      out__.write_free_lb(0, muc);
      local_scalar_t__ muv = DUMMY_VAR__;
      current_statement__ = 6;
      muv = in__.read<local_scalar_t__>();
      out__.write_free_lb(0, muv);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  }
  ...
  transform_inits_impl(const stan::io::var_context& context__, VecVar&
    ...
    try {
      ...
      context__.validate_dims("parameter initialization", "v", "double",
        std::vector<size_t>{static_cast<size_t>(L)});
      current_statement__ = 3;
      context__.validate_dims("parameter initialization", "sc", "double",
        std::vector<size_t>{});
      current_statement__ = 4;
      context__.validate_dims("parameter initialization", "sv", "double",
        std::vector<size_t>{});
      current_statement__ = 5;
      context__.validate_dims("parameter initialization", "muc", "double",
        std::vector<size_t>{});
      current_statement__ = 6;
      context__.validate_dims("parameter initialization", "muv", "double",
        std::vector<size_t>{});
      int pos__ = std::numeric_limits<int>::min();
      pos__ = 1;
      Eigen::Matrix<local_scalar_t__,-1,1> center =
      ...
      local_scalar_t__ muc = DUMMY_VAR__;
      current_statement__ = 5;
      muc = context__.vals_r("muc")[(1 - 1)];
      out__.write_free_lb(0, muc);
      local_scalar_t__ muv = DUMMY_VAR__;
      current_statement__ = 6;
      muv = context__.vals_r("muv")[(1 - 1)];
      out__.write_free_lb(0, muv);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"center", "v", "sc", "sv", "muc",
                "muv"};
    if (emit_transformed_parameters__) {
    ...
    if (emit_generated_quantities__) {
      std::vector<std::string> temp{"sdc", "sdv"};
      names__.reserve(names__.size() + temp.size());
      names__.insert(names__.end(), temp.begin(), temp.end());
    }
  }
  ...
  constrained_param_names(std::vector<std::string>& param_names__, bool
    ...
    param_names__.emplace_back(std::string() + "muc");
    param_names__.emplace_back(std::string() + "muv");
    if (emit_transformed_parameters__) {
      for (int sym1__ = 1; sym1__ <= L; ++sym1__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"center\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(L) + "},\"block\":\"parameters\"},{\"name\":\"v\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(L) + "},\"block\":\"parameters\"},{\"name\":\"sc\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sv\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"muc\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"muv\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"u\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(L) + "},\"block\":\"transformed_parameters\"},{\"name\":\"sdc\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"sdv\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((((L + L) + 1) + 1) + 1) + 1);
...
using stan_model = model_gencline_gl_mix_mu_namespace::model_gencline_gl_mix_mu;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_gencline_gl_mix_mu_namespace::profiles__;
}
#endif
#endif
