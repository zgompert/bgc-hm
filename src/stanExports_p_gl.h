...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_p_gl");
    reader.add_event(47, 45, "end", "model_p_gl");
    return reader;
}
...
class model_p_gl
  : public stan::model::model_base_crtp<model_p_gl> {
private:
        int L;
        int N0;
        int N1;
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N0; ++j) {
                    ...
                    lp_accum__.add(calc_lik(get_base1(get_base1(GL00, j, "GL00", 1), i, "GL00", 2), get_base1(get_base1(GL01, j, "GL01", 1), i, "GL01", 2), get_base1(get_base1(GL02, j, "GL02", 1), i, "GL02", 2), get_base1(P0, i, "P0", 1), pstream__));
                }
                current_statement_begin__ = 35;
                for (int j = 1; j <= N1; ++j) {
                    current_statement_begin__ = 37;
                    lp_accum__.add(calc_lik(get_base1(get_base1(GL10, j, "GL10", 1), i, "GL10", 2), get_base1(get_base1(GL11, j, "GL11", 1), i, "GL11", 2), get_base1(get_base1(GL12, j, "GL12", 1), i, "GL12", 2), get_base1(P1, i, "P1", 1), pstream__));
                }
            }
...
typedef model_p_gl_namespace::model_p_gl stan_model;
#ifndef USING_R
