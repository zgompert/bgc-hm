...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gencline_one_mix");
    reader.add_event(62, 60, "end", "model_gencline_one_mix");
    return reader;
}
...
class model_gencline_one_mix
  : public stan::model::model_base_crtp<model_gencline_one_mix> {
private:
        int L;
        int N;
        std::vector<double> G;
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            for (size_t i_0__ = 0; i_0__ < G_i_0_max__; ++i_0__) {
                ...
                check_less_or_equal(function__, "G[i_0__]", G[i_0__], 2);
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int j = 1; j <= N; ++j) {
                ...
                lp_accum__.add(calc_lik(get_base1(G, j, "G", 1), P0, P1, get_base1(H, j, "H", 1), v, u, get_base1(ploidy, j, "ploidy", 1), pstream__));
            }
...
typedef model_gencline_one_mix_namespace::model_gencline_one_mix stan_model;
#ifndef USING_R
