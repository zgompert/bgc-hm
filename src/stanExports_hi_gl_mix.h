...
namespace model_hi_gl_mix_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 43> locations_array__ =
  {" (found before start of program)",
  " (in 'hi_gl_mix', line 28, column 1 to column 31)",
  " (in 'hi_gl_mix', line 34, column 3 to column 85)",
  " (in 'hi_gl_mix', line 32, column 15 to line 35, column 3)",
  " (in 'hi_gl_mix', line 32, column 2 to line 35, column 3)",
  " (in 'hi_gl_mix', line 31, column 14 to line 36, column 2)",
  " (in 'hi_gl_mix', line 31, column 1 to line 36, column 2)",
  " (in 'hi_gl_mix', line 39, column 2 to column 39)",
  " (in 'hi_gl_mix', line 37, column 14 to line 40, column 2)",
  " (in 'hi_gl_mix', line 37, column 1 to line 40, column 2)",
  " (in 'hi_gl_mix', line 18, column 1 to column 7)",
  " (in 'hi_gl_mix', line 19, column 1 to column 7)",
  " (in 'hi_gl_mix', line 20, column 28 to column 29)",
  " (in 'hi_gl_mix', line 20, column 31 to column 32)",
  " (in 'hi_gl_mix', line 20, column 1 to column 34)",
  " (in 'hi_gl_mix', line 21, column 28 to column 29)",
  " (in 'hi_gl_mix', line 21, column 31 to column 32)",
  " (in 'hi_gl_mix', line 21, column 1 to column 34)",
  " (in 'hi_gl_mix', line 22, column 28 to column 29)",
  " (in 'hi_gl_mix', line 22, column 31 to column 32)",
  " (in 'hi_gl_mix', line 22, column 1 to column 34)",
  " (in 'hi_gl_mix', line 23, column 31 to column 32)",
  " (in 'hi_gl_mix', line 23, column 34 to column 35)",
  " (in 'hi_gl_mix', line 23, column 1 to column 37)",
  " (in 'hi_gl_mix', line 24, column 26 to column 27)",
  " (in 'hi_gl_mix', line 24, column 1 to column 32)",
  " (in 'hi_gl_mix', line 25, column 26 to column 27)",
  " (in 'hi_gl_mix', line 25, column 1 to column 32)",
  " (in 'hi_gl_mix', line 28, column 26 to column 27)",
  " (in 'hi_gl_mix', line 3, column 2 to column 12)",
  " (in 'hi_gl_mix', line 12, column 6 to column 13)",
  " (in 'hi_gl_mix', line 11, column 11 to line 13, column 6)",
  " (in 'hi_gl_mix', line 9, column 9 to column 60)",
  " (in 'hi_gl_mix', line 10, column 6 to column 68)",
  " (in 'hi_gl_mix', line 8, column 21 to line 11, column 6)",
  " (in 'hi_gl_mix', line 8, column 12 to line 13, column 6)",
  " (in 'hi_gl_mix', line 5, column 6 to column 92)",
  " (in 'hi_gl_mix', line 6, column 6 to column 112)",
  " (in 'hi_gl_mix', line 7, column 6 to column 84)",
  " (in 'hi_gl_mix', line 4, column 11 to line 8, column 6)",
  " (in 'hi_gl_mix', line 4, column 2 to line 13, column 6)",
  " (in 'hi_gl_mix', line 14, column 2 to column 14)",
  " (in 'hi_gl_mix', line 2, column 79 to line 15, column 2)"};
...
calc_lik(const T0__& gl0, const T1__& gl1, const T2__& gl2, const T3__& p0,
         const T4__& p1, const T5__& h, const T6__& pl, std::ostream*
         pstream__);
template <typename T0__, typename T1__, typename T2__, typename T3__,
          typename T4__, typename T5__, typename T6__,
          stan::require_all_t<stan::is_stan_scalar<T0__>,
...
calc_lik(const T0__& gl0, const T1__& gl1, const T2__& gl2, const T3__& p0,
  ...
  try {
    ...
    if (stan::math::logical_eq(pl, 2)) {
      ...
      prob = stan::math::log_sum_exp(prob,
               (stan::math::log(((h * p1) + ((1 - h) * p0))) +
               stan::math::log(((h * p1) + ((1 - h) * p0)))));
    } else {
...
class model_hi_gl_mix final : public model_base_crtp<model_hi_gl_mix> {
private:
  int L;
  int N;
...
public:
  ~model_hi_gl_mix() {}
  model_hi_gl_mix(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_hi_gl_mix_namespace::model_hi_gl_mix";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_hi_gl_mix_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_hi_gl_mix_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_hi_gl_mix_namespace::model_hi_gl_mix;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_hi_gl_mix_namespace::profiles__;
}
#endif
#endif
