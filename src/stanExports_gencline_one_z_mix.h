...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gencline_one_z_mix");
    reader.add_event(63, 61, "end", "model_gencline_one_z_mix");
    return reader;
}
...
class model_gencline_one_z_mix
  : public stan::model::model_base_crtp<model_gencline_one_z_mix> {
private:
        int L;
        int N;
        std::vector<double> Z;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int j = 1; j <= N; ++j) {
                ...
                lp_accum__.add(calc_lik(get_base1(Z, j, "Z", 1), get_base1(H, j, "H", 1), v, u, get_base1(ploidy, j, "ploidy", 1), pstream__));
            }
...
typedef model_gencline_one_z_mix_namespace::model_gencline_one_z_mix stan_model;
#ifndef USING_R
