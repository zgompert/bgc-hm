...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_hi_z_mix");
    reader.add_event(49, 47, "end", "model_hi_z_mix");
    return reader;
}
...
calc_lik(const T0__& z,
             const T1__& h,
             const T2__& pl, std::ostream* pstream__) {
    ...
    try {
        ...
        if (as_bool(logical_eq(pl, 2))) {
            ...
            if (as_bool(logical_eq(z, 0))) {
                ...
                stan::math::assign(prob, (stan::math::log((1 - h)) + stan::math::log((1 - h))));
            } else if (as_bool(logical_eq(z, 1))) {
                current_statement_begin__ = 8;
                stan::math::assign(prob, ((stan::math::log(2) + stan::math::log(h)) + stan::math::log((1 - h))));
            } else {
                current_statement_begin__ = 10;
                stan::math::assign(prob, (stan::math::log(h) + stan::math::log(h)));
            }
        } else if (as_bool(logical_eq(pl, 1))) {
            current_statement_begin__ = 12;
            if (as_bool(logical_eq(z, 0))) {
                current_statement_begin__ = 13;
                stan::math::assign(prob, stan::math::log((1 - h)));
            } else {
                current_statement_begin__ = 15;
                stan::math::assign(prob, stan::math::log(h));
            }
        } else {
...
struct calc_lik_functor__ {
    ...
    operator()(const T0__& z,
             const T1__& h,
             const T2__& pl, std::ostream* pstream__) const {
        return calc_lik(z, h, pl, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_hi_z_mix
  : public stan::model::model_base_crtp<model_hi_z_mix> {
private:
        int L;
        int N;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "Z", "int", context__.to_vec(N,L));
            Z = std::vector<std::vector<int> >(N, std::vector<int>(L, int(0)));
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N; ++j) {
                    ...
                    lp_accum__.add(calc_lik(get_base1(get_base1(Z, j, "Z", 1), i, "Z", 2), get_base1(H, j, "H", 1), get_base1(get_base1(ploidy, j, "ploidy", 1), i, "ploidy", 2), pstream__));
                }
            }
...
typedef model_hi_z_mix_namespace::model_hi_z_mix stan_model;
#ifndef USING_R
