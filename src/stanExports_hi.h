...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'hi', line 21, column 1 to column 31)",
                                                      " (in 'hi', line 27, column 3 to column 50)",
                                                      " (in 'hi', line 25, column 15 to line 28, column 3)",
                                                      " (in 'hi', line 25, column 2 to line 28, column 3)",
                                                      " (in 'hi', line 24, column 14 to line 29, column 2)",
                                                      " (in 'hi', line 24, column 1 to line 29, column 2)",
                                                      " (in 'hi', line 32, column 2 to column 39)",
                                                      " (in 'hi', line 30, column 14 to line 33, column 2)",
                                                      " (in 'hi', line 30, column 1 to line 33, column 2)",
                                                      " (in 'hi', line 14, column 1 to column 7)",
                                                      " (in 'hi', line 15, column 1 to column 7)",
                                                      " (in 'hi', line 16, column 25 to column 26)",
                                                      " (in 'hi', line 16, column 28 to column 29)",
                                                      " (in 'hi', line 16, column 1 to column 31)",
                                                      " (in 'hi', line 17, column 26 to column 27)",
                                                      " (in 'hi', line 17, column 1 to column 32)",
                                                      " (in 'hi', line 18, column 26 to column 27)",
                                                      " (in 'hi', line 18, column 1 to column 32)",
                                                      " (in 'hi', line 21, column 26 to column 27)",
                                                      " (in 'hi', line 3, column 2 to column 12)",
                                                      " (in 'hi', line 9, column 3 to column 62)",
                                                      " (in 'hi', line 7, column 3 to column 79)",
                                                      " (in 'hi', line 6, column 7 to line 9, column 62)",
                                                      " (in 'hi', line 5, column 3 to column 78)",
                                                      " (in 'hi', line 4, column 2 to line 9, column 62)",
                                                      " (in 'hi', line 10, column 2 to column 14)",
                                                      " (in 'hi', line 2, column 48 to line 11, column 2)"};
...
{
return calc_lik(g, p0, p1, h, pstream__);
}
};
#include <stan_meta_header.hpp>
class model_hi final : public model_base_crtp<model_hi> {
private:
  int L;
  int N;
...
public:
  ...
  inline std::string model_name() const final { return "model_hi"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_hi(stan::io::var_context& context__, unsigned int random_seed__ = 0,
           std::ostream* pstream__ = nullptr) : model_base_crtp(0) {
    using local_scalar_t__ = double ;
    boost::ecuyer1988 base_rng__ = 
        stan::services::util::create_rng(random_seed__, 0);
    (void) base_rng__;  // suppress unused var warning
    static const char* function__ = "model_hi_namespace::model_hi";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_hi_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_hi_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_hi_namespace::model_hi;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_hi_namespace::profiles__;
}
#endif
#endif
