...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gencline_one");
    reader.add_event(55, 53, "end", "model_gencline_one");
    return reader;
}
...
class model_gencline_one
  : public stan::model::model_base_crtp<model_gencline_one> {
private:
        int L;
        int N;
        std::vector<double> G;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int j = 1; j <= N; ++j) {
                ...
                lp_accum__.add(calc_lik(get_base1(G, j, "G", 1), P0, P1, get_base1(H, j, "H", 1), v, u, pstream__));
            }
...
typedef model_gencline_one_namespace::model_gencline_one stan_model;
#ifndef USING_R
