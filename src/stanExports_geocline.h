...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(46, 44, "end", "model_geocline");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "P", "double", context__.to_vec(J,L));
            P = std::vector<std::vector<double> >(J, std::vector<double>(L, double(0)));
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= J; ++j) {
                    ...
                    lp_accum__.add(normal_log(get_base1(get_base1(P, j, "P", 1), i, "P", 2), (get_base1(cent, i, "cent", 1) + (get_base1(slope, i, "slope", 1) * get_base1(geo, j, "geo", 1))), serr));
                }
            }
