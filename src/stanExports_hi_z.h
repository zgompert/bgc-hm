...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_hi_z");
    reader.add_event(39, 37, "end", "model_hi_z");
    return reader;
}
template <typename T0__, typename T1__>
typename boost::math::tools::promote_args<T0__, T1__>::type
calc_lik(const T0__& z,
             const T1__& h, std::ostream* pstream__) {
...
struct calc_lik_functor__ {
    ...
    operator()(const T0__& z,
             const T1__& h, std::ostream* pstream__) const {
        return calc_lik(z, h, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_hi_z
  : public stan::model::model_base_crtp<model_hi_z> {
private:
        int L;
        int N;
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N; ++j) {
                    ...
                    lp_accum__.add(calc_lik(get_base1(get_base1(Z, j, "Z", 1), i, "Z", 2), get_base1(H, j, "H", 1), pstream__));
                }
            }
...
typedef model_hi_z_namespace::model_hi_z stan_model;
#ifndef USING_R
