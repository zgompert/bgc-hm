...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'gencline_mix_mu', line 37, column 1 to column 43)",
                                                      " (in 'gencline_mix_mu', line 38, column 1 to column 33)",
                                                      " (in 'gencline_mix_mu', line 39, column 1 to column 18)",
                                                      " (in 'gencline_mix_mu', line 40, column 1 to column 18)",
                                                      " (in 'gencline_mix_mu', line 41, column 8 to column 26)",
                                                      " (in 'gencline_mix_mu', line 42, column 8 to column 26)",
                                                      " (in 'gencline_mix_mu', line 45, column 1 to column 36)",
                                                      " (in 'gencline_mix_mu', line 47, column 2 to column 33)",
                                                      " (in 'gencline_mix_mu', line 46, column 14 to line 48, column 2)",
                                                      " (in 'gencline_mix_mu', line 46, column 1 to line 48, column 2)",
                                                      " (in 'gencline_mix_mu', line 70, column 1 to column 19)",
                                                      " (in 'gencline_mix_mu', line 71, column 1 to column 19)",
                                                      " (in 'gencline_mix_mu', line 72, column 1 to column 25)",
                                                      " (in 'gencline_mix_mu', line 73, column 1 to column 20)",
                                                      " (in 'gencline_mix_mu', line 54, column 3 to column 75)",
                                                      " (in 'gencline_mix_mu', line 52, column 15 to line 55, column 3)",
                                                      " (in 'gencline_mix_mu', line 52, column 2 to line 55, column 3)",
                                                      " (in 'gencline_mix_mu', line 51, column 14 to line 56, column 2)",
                                                      " (in 'gencline_mix_mu', line 51, column 1 to line 56, column 2)",
                                                      " (in 'gencline_mix_mu', line 59, column 2 to column 52)",
                                                      " (in 'gencline_mix_mu', line 60, column 2 to column 47)",
                                                      " (in 'gencline_mix_mu', line 57, column 16 to line 61, column 2)",
                                                      " (in 'gencline_mix_mu', line 57, column 1 to line 61, column 2)",
                                                      " (in 'gencline_mix_mu', line 63, column 1 to column 34)",
                                                      " (in 'gencline_mix_mu', line 64, column 1 to column 34)",
                                                      " (in 'gencline_mix_mu', line 66, column 8 to column 42)",
                                                      " (in 'gencline_mix_mu', line 67, column 8 to column 42)",
                                                      " (in 'gencline_mix_mu', line 28, column 1 to column 7)",
                                                      " (in 'gencline_mix_mu', line 29, column 1 to column 7)",
                                                      " (in 'gencline_mix_mu', line 30, column 26 to column 27)",
                                                      " (in 'gencline_mix_mu', line 30, column 29 to column 30)",
                                                      " (in 'gencline_mix_mu', line 30, column 1 to column 32)",
                                                      " (in 'gencline_mix_mu', line 31, column 31 to column 32)",
                                                      " (in 'gencline_mix_mu', line 31, column 34 to column 35)",
                                                      " (in 'gencline_mix_mu', line 31, column 1 to column 37)",
                                                      " (in 'gencline_mix_mu', line 32, column 26 to column 27)",
                                                      " (in 'gencline_mix_mu', line 32, column 1 to column 31)",
                                                      " (in 'gencline_mix_mu', line 33, column 26 to column 27)",
                                                      " (in 'gencline_mix_mu', line 33, column 1 to column 32)",
                                                      " (in 'gencline_mix_mu', line 34, column 26 to column 27)",
                                                      " (in 'gencline_mix_mu', line 34, column 1 to column 32)",
                                                      " (in 'gencline_mix_mu', line 37, column 33 to column 34)",
                                                      " (in 'gencline_mix_mu', line 38, column 28 to column 29)",
                                                      " (in 'gencline_mix_mu', line 45, column 31 to column 32)",
                                                      ...
                                                      " (in 'gencline_mix_mu', line 22, column 18 to column 55)",
                                                      " (in 'gencline_mix_mu', line 20, column 18 to column 62)",
                                                      " (in 'gencline_mix_mu', line 19, column 14 to line 22, column 55)",
                                                      " (in 'gencline_mix_mu', line 18, column 16 to line 23, column 10)",
                                                      ...
                                                      " (in 'gencline_mix_mu', line 11, column 2 to line 23, column 10)",
                                                      " (in 'gencline_mix_mu', line 24, column 2 to column 14)",
                                                      " (in 'gencline_mix_mu', line 7, column 75 to line 25, column 2)"};
...
calc_lik(const T0__& g, const T1__& p0, const T2__& p1, const T3__& h,
         const T4__& vv, const T5__& uu, const T6__& pl,
         std::ostream* pstream__) {
...
stan::promote_args_t<T0__, T1__, T2__, T3__, T4__, stan::promote_args_t<T5__,
T6__>>
operator()(const T0__& g, const T1__& p0, const T2__& p1, const T3__& h,
           const T4__& vv, const T5__& uu, const T6__& pl,
           std::ostream* pstream__)  const 
{
return calc_lik(g, p0, p1, h, vv, uu, pl, pstream__);
}
};
...
public:
  ...
  inline std::string model_name() const final { return "model_gencline_mix_mu"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_gencline_mix_mu(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_gencline_mix_mu_namespace::model_gencline_mix_mu";
    ...
    try {
      ...
      G = std::vector<std::vector<double>>(N, std::vector<double>(L, std::numeric_limits<double>::quiet_NaN()));
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_gencline_mix_mu_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      if (jacobian__) {
        current_statement__ = 5;
        muc = stan::math::lb_constrain(muc, 0, lp__);
      } else {
        current_statement__ = 5;
        muc = stan::math::lb_constrain(muc, 0);
      }
      ...
      if (jacobian__) {
        current_statement__ = 6;
        muv = stan::math::lb_constrain(muv, 0, lp__);
      } else {
        current_statement__ = 6;
        muv = stan::math::lb_constrain(muv, 0);
      }
          ...
          for (int j = 1; j <= N; ++j) {
            ...
            lp_accum__.add(
              calc_lik(G[(j - 1)][(i - 1)], P0[(i - 1)], P1[(i - 1)],
                H[(j - 1)], v[(i - 1)], u[(i - 1)],
                ploidy[(j - 1)][(i - 1)], pstream__));}}
        current_statement__ = 23;
        for (int i = 1; i <= L; ++i) {
          current_statement__ = 20;
          lp_accum__.add(normal_lpdf<false>(logit(center[(i - 1)]), muc, sc));
          current_statement__ = 21;
          lp_accum__.add(
            normal_lpdf<false>(stan::math::log10(v[(i - 1)]), muv, sv));}
        current_statement__ = 24;
        lp_accum__.add(normal_lpdf<false>(sc, 0, 1));
        current_statement__ = 25;
        lp_accum__.add(normal_lpdf<false>(sv, 0, 1));
        current_statement__ = 26;
        lp_accum__.add(normal_lpdf<false>(muc, 0, 1));
        current_statement__ = 27;
        lp_accum__.add(normal_lpdf<false>(muv, 0, 1));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_gencline_mix_mu_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
    ...
    try {
      ...
      sv = stan::math::lb_constrain(sv, 0);
      double muc;
      muc = std::numeric_limits<double>::quiet_NaN();
      ...
      muc = stan::math::lb_constrain(muc, 0);
      double muv;
      muv = std::numeric_limits<double>::quiet_NaN();
      ...
      vars__.emplace_back(muc);
      vars__.emplace_back(muv);
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      double muc_free__;
      muc_free__ = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 5;
      muc_free__ = stan::math::lb_free(muc, 0);
      double muv;
      muv = std::numeric_limits<double>::quiet_NaN();
      ...
      double muv_free__;
      muv_free__ = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 6;
      muv_free__ = stan::math::lb_free(muv, 0);
      for (int sym1__ = 1; sym1__ <= L; ++sym1__) {
      ...
      vars__.emplace_back(muc_free__);
      vars__.emplace_back(muv_free__);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
      throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***"); 
  ...
  inline void get_param_names(std::vector<std::string>& names__) const {
    ...
    names__.emplace_back("muc");
    names__.emplace_back("muv");
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"center\",\"type\":{\"name\":\"vector\",\"length\":" << L << "},\"block\":\"parameters\"},{\"name\":\"v\",\"type\":{\"name\":\"vector\",\"length\":" << L << "},\"block\":\"parameters\"},{\"name\":\"sc\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sv\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"muc\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"muv\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"u\",\"type\":{\"name\":\"vector\",\"length\":" << L << "},\"block\":\"transformed_parameters\"},{\"name\":\"sdc\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"sdv\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]";
    return s__.str();
