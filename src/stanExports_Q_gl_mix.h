...
namespace model_Q_gl_mix_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'Q_gl_mix', line 26, column 1 to column 17)",
                                                      " (in 'Q_gl_mix', line 41, column 1 to column 31)",
                                                      " (in 'Q_gl_mix', line 43, column 2 to column 33)",
                                                      " (in 'Q_gl_mix', line 42, column 14 to line 44, column 2)",
                                                      " (in 'Q_gl_mix', line 42, column 1 to line 44, column 2)",
                                                      " (in 'Q_gl_mix', line 32, column 3 to column 106)",
                                                      " (in 'Q_gl_mix', line 30, column 15 to line 33, column 3)",
                                                      " (in 'Q_gl_mix', line 30, column 2 to line 33, column 3)",
                                                      " (in 'Q_gl_mix', line 29, column 14 to line 34, column 2)",
                                                      " (in 'Q_gl_mix', line 29, column 1 to line 34, column 2)",
                                                      " (in 'Q_gl_mix', line 37, column 2 to column 54)",
                                                      " (in 'Q_gl_mix', line 35, column 14 to line 38, column 2)",
                                                      " (in 'Q_gl_mix', line 35, column 1 to line 38, column 2)",
                                                      " (in 'Q_gl_mix', line 16, column 1 to column 7)",
                                                      " (in 'Q_gl_mix', line 17, column 1 to column 7)",
                                                      " (in 'Q_gl_mix', line 18, column 28 to column 29)",
                                                      " (in 'Q_gl_mix', line 18, column 31 to column 32)",
                                                      " (in 'Q_gl_mix', line 18, column 1 to column 34)",
                                                      " (in 'Q_gl_mix', line 19, column 28 to column 29)",
                                                      " (in 'Q_gl_mix', line 19, column 31 to column 32)",
                                                      " (in 'Q_gl_mix', line 19, column 1 to column 34)",
                                                      " (in 'Q_gl_mix', line 20, column 28 to column 29)",
                                                      " (in 'Q_gl_mix', line 20, column 31 to column 32)",
                                                      " (in 'Q_gl_mix', line 20, column 1 to column 34)",
                                                      " (in 'Q_gl_mix', line 21, column 34 to column 35)",
                                                      " (in 'Q_gl_mix', line 21, column 37 to column 38)",
                                                      " (in 'Q_gl_mix', line 21, column 4 to column 40)",
                                                      " (in 'Q_gl_mix', line 22, column 26 to column 27)",
                                                      " (in 'Q_gl_mix', line 22, column 1 to column 32)",
                                                      " (in 'Q_gl_mix', line 23, column 26 to column 27)",
                                                      " (in 'Q_gl_mix', line 23, column 1 to column 32)",
                                                      " (in 'Q_gl_mix', line 26, column 14 to column 15)",
                                                      " (in 'Q_gl_mix', line 41, column 26 to column 27)",
                                                      " (in 'Q_gl_mix', line 3, column 2 to column 12)",
                                                      " (in 'Q_gl_mix', line 9, column 6 to column 99)",
                                                      " (in 'Q_gl_mix', line 10, column 9 to column 104)",
                                                      " (in 'Q_gl_mix', line 8, column 12 to line 11, column 6)",
                                                      " (in 'Q_gl_mix', line 5, column 3 to column 96)",
                                                      " (in 'Q_gl_mix', line 6, column 6 to column 134)",
                                                      " (in 'Q_gl_mix', line 7, column 9 to column 97)",
                                                      " (in 'Q_gl_mix', line 4, column 11 to line 8, column 6)",
                                                      " (in 'Q_gl_mix', line 4, column 2 to line 11, column 6)",
                                                      " (in 'Q_gl_mix', line 12, column 2 to column 14)",
                                                      " (in 'Q_gl_mix', line 2, column 101 to line 13, column 2)"};
...
{
return calc_lik(gl0, gl1, gl2, p0, p1, q11, q10, q00, pl, pstream__);
}
};
#include <stan_meta_header.hpp>
class model_Q_gl_mix final : public model_base_crtp<model_Q_gl_mix> {
private:
  int L;
  int N;
...
public:
  ...
  inline std::string model_name() const final { return "model_Q_gl_mix"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_Q_gl_mix(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_Q_gl_mix_namespace::model_Q_gl_mix";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_Q_gl_mix_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_Q_gl_mix_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_Q_gl_mix_namespace::model_Q_gl_mix;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_Q_gl_mix_namespace::profiles__;
}
#endif
#endif
