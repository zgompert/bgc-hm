  ...
  try {
    ...
    if (stan::math::logical_eq(g, 0)) {
      ...
      if (stan::math::logical_eq(g, 1)) {
        ...
        prob = stan::math::log(((((((q11 * 2) * (1 - p0)) * p0) + (((q00 * 2)
...
public:
  ...
  model_Q(stan::io::var_context& context__, unsigned int random_seed__ = 0,
    ...
    // suppress unused var warning
    (void) base_rng__;
    static constexpr const char* function__ = "model_Q_namespace::model_Q";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    // suppress unused var warning
    (void) DUMMY_VAR__;
    static constexpr const char* function__ = "model_Q_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
