...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Q_z");
    reader.add_event(47, 45, "end", "model_Q_z");
    return reader;
}
...
calc_lik(const T0__& z,
             const T1__& q11,
             const T2__& q10,
             const T3__& q00, std::ostream* pstream__) {
...
struct calc_lik_functor__ {
    ...
    operator()(const T0__& z,
             const T1__& q11,
             const T2__& q10,
             const T3__& q00, std::ostream* pstream__) const {
        return calc_lik(z, q11, q10, q00, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_Q_z
  : public stan::model::model_base_crtp<model_Q_z> {
private:
        int L;
        int N;
        std::vector<std::vector<int> > Z;
public:
    model_Q_z(stan::io::var_context& context__,
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N; ++j) {
                    ...
                    lp_accum__.add(calc_lik(get_base1(get_base1(Z, j, "Z", 1), i, "Z", 2), get_base1(get_base1(Q, j, "Q", 1), 1, "Q", 2), get_base1(get_base1(Q, j, "Q", 1), 2, "Q", 2), get_base1(get_base1(Q, j, "Q", 1), 3, "Q", 2), pstream__));
                }
            }
...
typedef model_Q_z_namespace::model_Q_z stan_model;
#ifndef USING_R
