...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gencline_sdk_gl_mix");
    reader.add_event(69, 67, "end", "model_gencline_sdk_gl_mix");
    return reader;
}
...
class model_gencline_sdk_gl_mix
  : public stan::model::model_base_crtp<model_gencline_sdk_gl_mix> {
private:
        int L;
        int N;
...
typedef model_gencline_sdk_gl_mix_namespace::model_gencline_sdk_gl_mix stan_model;
#ifndef USING_R
