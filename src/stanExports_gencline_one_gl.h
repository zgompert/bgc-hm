...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gencline_one_gl");
    reader.add_event(54, 52, "end", "model_gencline_one_gl");
    return reader;
}
...
class model_gencline_one_gl
  : public stan::model::model_base_crtp<model_gencline_one_gl> {
private:
        int L;
        int N;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "GL0", "double", context__.to_vec(N));
            GL0 = std::vector<double>(N, double(0));
            vals_r__ = context__.vals_r("GL0");
            pos__ = 0;
            size_t GL0_k_0_max__ = N;
            for (size_t k_0__ = 0; k_0__ < GL0_k_0_max__; ++k_0__) {
                GL0[k_0__] = vals_r__[pos__++];
            }
            size_t GL0_i_0_max__ = N;
            for (size_t i_0__ = 0; i_0__ < GL0_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "GL0[i_0__]", GL0[i_0__], 0);
                check_less_or_equal(function__, "GL0[i_0__]", GL0[i_0__], 2);
            }
            current_statement_begin__ = 23;
            validate_non_negative_index("GL1", "N", N);
            context__.validate_dims("data initialization", "GL1", "double", context__.to_vec(N));
            GL1 = std::vector<double>(N, double(0));
            vals_r__ = context__.vals_r("GL1");
            pos__ = 0;
            size_t GL1_k_0_max__ = N;
            for (size_t k_0__ = 0; k_0__ < GL1_k_0_max__; ++k_0__) {
                GL1[k_0__] = vals_r__[pos__++];
            }
            size_t GL1_i_0_max__ = N;
            for (size_t i_0__ = 0; i_0__ < GL1_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "GL1[i_0__]", GL1[i_0__], 0);
                check_less_or_equal(function__, "GL1[i_0__]", GL1[i_0__], 2);
            }
            current_statement_begin__ = 24;
            validate_non_negative_index("GL2", "N", N);
            context__.validate_dims("data initialization", "GL2", "double", context__.to_vec(N));
            GL2 = std::vector<double>(N, double(0));
            vals_r__ = context__.vals_r("GL2");
            pos__ = 0;
            size_t GL2_k_0_max__ = N;
            for (size_t k_0__ = 0; k_0__ < GL2_k_0_max__; ++k_0__) {
                GL2[k_0__] = vals_r__[pos__++];
            }
            size_t GL2_i_0_max__ = N;
            for (size_t i_0__ = 0; i_0__ < GL2_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "GL2[i_0__]", GL2[i_0__], 0);
                check_less_or_equal(function__, "GL2[i_0__]", GL2[i_0__], 2);
            }
            ...
            context__.validate_dims("data initialization", "P0", "double", context__.to_vec());
            P0 = double(0);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int j = 1; j <= N; ++j) {
                ...
                lp_accum__.add(calc_lik(get_base1(GL0, j, "GL0", 1), get_base1(GL1, j, "GL1", 1), get_base1(GL2, j, "GL2", 1), P0, P1, get_base1(H, j, "H", 1), v, u, pstream__));
            }
...
typedef model_gencline_one_gl_namespace::model_gencline_one_gl stan_model;
#ifndef USING_R
