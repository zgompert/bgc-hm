...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gencline_gl_mix_mu");
    reader.add_event(86, 84, "end", "model_gencline_gl_mix_mu");
    return reader;
}
...
calc_lik(const T0__& gl0,
    ...
    try {
        ...
        if (as_bool(logical_eq(pl, 2))) {
            ...
            stan::math::assign(prob, (stan::math::log(gl0) + stan::math::log(((phi * (1 - p1)) + ((1 - phi) * (1 - p0))))));
            current_statement_begin__ = 19;
            stan::math::assign(prob, log_sum_exp(prob, (stan::math::log(gl2) + stan::math::log(((phi * p1) + ((1 - phi) * p0))))));
        }
...
class model_gencline_gl_mix_mu
  : public stan::model::model_base_crtp<model_gencline_gl_mix_mu> {
private:
        int L;
        int N;
        ...
        double mu0;
public:
    model_gencline_gl_mix_mu(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gencline_gl_mix_mu_namespace::model_gencline_gl_mix_mu";
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N; ++j) {
                    ...
                    lp_accum__.add(calc_lik(get_base1(get_base1(GL0, j, "GL0", 1), i, "GL0", 2), get_base1(get_base1(GL1, j, "GL1", 1), i, "GL1", 2), get_base1(get_base1(GL2, j, "GL2", 1), i, "GL2", 2), get_base1(P0, i, "P0", 1), get_base1(P1, i, "P1", 1), get_base1(H, j, "H", 1), get_base1(v, i, "v", 1), get_base1(u, i, "u", 1), get_base1(get_base1(ploidy, j, "ploidy", 1), i, "ploidy", 2), pstream__));
                }
            }
            ...
            lp_accum__.add(normal_log(sc, 0, sd0));
            current_statement_begin__ = 71;
            lp_accum__.add(normal_log(sv, 0, sd0));
            current_statement_begin__ = 73;
            lp_accum__.add(normal_log(muc, 0, mu0));
            current_statement_begin__ = 74;
            lp_accum__.add(normal_log(muv, 0, mu0));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gencline_gl_mix_mu_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_gencline_gl_mix_mu_namespace::model_gencline_gl_mix_mu stan_model;
#ifndef USING_R
