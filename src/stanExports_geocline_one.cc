...
#include "stanExports_geocline_one.h"

RCPP_MODULE(stan_fit4geocline_one_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_geocline_one")
