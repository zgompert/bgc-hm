...
#include "stanExports_gencline_sdk_z.h"

RCPP_MODULE(stan_fit4gencline_sdk_z_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_gencline_sdk_z")
