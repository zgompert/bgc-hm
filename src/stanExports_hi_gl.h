...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_hi_gl");
    reader.add_event(40, 38, "end", "model_hi_gl");
    return reader;
}
...
calc_lik(const T0__& gl0,
             ...
             const T3__& p0,
             const T4__& p1,
             const T5__& h, std::ostream* pstream__) {
    ...
    try {
        ...
        stan::math::assign(prob, log_sum_exp(prob, ((stan::math::log(gl2) + stan::math::log(((h * p1) + ((1 - h) * p0)))) + stan::math::log(((h * p1) + ((1 - h) * p0))))));
...
struct calc_lik_functor__ {
    ...
    operator()(const T0__& gl0,
             ...
             const T3__& p0,
             const T4__& p1,
             const T5__& h, std::ostream* pstream__) const {
        return calc_lik(gl0, gl1, gl2, p0, p1, h, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_hi_gl
  : public stan::model::model_base_crtp<model_hi_gl> {
private:
        int L;
        int N;
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N; ++j) {
                    ...
                    lp_accum__.add(calc_lik(get_base1(get_base1(GL0, j, "GL0", 1), i, "GL0", 2), get_base1(get_base1(GL1, j, "GL1", 1), i, "GL1", 2), get_base1(get_base1(GL2, j, "GL2", 1), i, "GL2", 2), get_base1(P0, i, "P0", 1), get_base1(P1, i, "P1", 1), get_base1(H, j, "H", 1), pstream__));
                }
            }
...
typedef model_hi_gl_namespace::model_hi_gl stan_model;
#ifndef USING_R
