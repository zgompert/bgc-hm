...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'p', line 5, column 26 to column 28)",
                                                      " (in 'p', line 5, column 30 to column 31)",
                                                      " (in 'p', line 5, column 1 to column 33)",
                                                      " (in 'p', line 6, column 26 to column 28)",
                                                      " (in 'p', line 6, column 30 to column 31)",
                                                      " (in 'p', line 6, column 1 to column 33)",
...
public:
  ...
  inline std::string model_name() const final { return "model_p"; }
  ...
  model_p(stan::io::var_context& context__, unsigned int random_seed__ = 0,
    ...
    static const char* function__ = "model_p_namespace::model_p";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_p_namespace::log_prob";
(void) function__;  // suppress unused var warning
        ...
        }}
      {
        ...
        for (int i = 1; i <= L; ++i) {
          ...
          for (int j = 1; j <= N0; ++j) {
            ...
            lp_accum__.add(
              binomial_lpmf<false>(G0[(j - 1)][(i - 1)], 2, P0[(i - 1)]));}
          current_statement__ = 8;
          for (int j = 1; j <= N1; ++j) {
            current_statement__ = 6;
            lp_accum__.add(
              binomial_lpmf<false>(G1[(j - 1)][(i - 1)], 2, P1[(i - 1)]));}}
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_p_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
