...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gencline_sdk_gl");
    reader.add_event(60, 58, "end", "model_gencline_sdk_gl");
    return reader;
}
...
class model_gencline_sdk_gl
  : public stan::model::model_base_crtp<model_gencline_sdk_gl> {
private:
        int L;
        int N;
...
typedef model_gencline_sdk_gl_namespace::model_gencline_sdk_gl stan_model;
#ifndef USING_R
