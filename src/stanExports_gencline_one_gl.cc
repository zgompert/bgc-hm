...
#include "stanExports_gencline_one_gl.h"

RCPP_MODULE(stan_fit4gencline_one_gl_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_gencline_one_gl")
