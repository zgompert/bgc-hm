...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Q_gl_mix");
    reader.add_event(57, 55, "end", "model_Q_gl_mix");
    return reader;
}
...
calc_lik(const T0__& gl0,
    ...
    try {
        ...
        if (as_bool(logical_eq(pl, 2))) {
            ...
            stan::math::assign(prob, (stan::math::log(gl0) + stan::math::log(((((q11 * (1 - p1)) * (1 - p1)) + ((q00 * (1 - p0)) * (1 - p0))) + ((q10 * (1 - p1)) * (1 - p0))))));
            current_statement_begin__ = 6;
            stan::math::assign(prob, log_sum_exp(prob, (stan::math::log(gl1) + stan::math::log(((((((q11 * 2) * (1 - p0)) * p0) + (((q00 * 2) * (1 - p1)) * p1)) + ((q10 * (1 - p0)) * p1)) + ((q10 * p0) * (1 - p1)))))));
            current_statement_begin__ = 7;
            stan::math::assign(prob, log_sum_exp(prob, (stan::math::log(gl2) + stan::math::log(((((q11 * p1) * p1) + ((q00 * p0) * p0)) + ((q10 * p1) * p0))))));
        } else if (as_bool(logical_eq(pl, 1))) {
            current_statement_begin__ = 9;
            stan::math::assign(prob, (stan::math::log(gl0) + stan::math::log(((((q11 * (1 - p1)) + (q00 * (1 - p0))) + ((0.5 * q10) * (1 - p1))) + ((0.5 * q10) * (1 - p0))))));
            current_statement_begin__ = 10;
            stan::math::assign(prob, log_sum_exp(prob, (stan::math::log(gl1) + stan::math::log(((((q11 * p1) + (q00 * p0)) + ((0.5 * q10) * p1)) + ((0.5 * q10) * p0))))));
        } else {
...
class model_Q_gl_mix
  : public stan::model::model_base_crtp<model_Q_gl_mix> {
private:
        int L;
        int N;
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N; ++j) {
                    ...
                    lp_accum__.add(calc_lik(get_base1(get_base1(GL0, j, "GL0", 1), i, "GL0", 2), get_base1(get_base1(GL1, j, "GL1", 1), i, "GL1", 2), get_base1(get_base1(GL2, j, "GL2", 1), i, "GL2", 2), get_base1(P0, i, "P0", 1), get_base1(P1, i, "P1", 1), get_base1(get_base1(Q, j, "Q", 1), 1, "Q", 2), get_base1(get_base1(Q, j, "Q", 1), 2, "Q", 2), get_base1(get_base1(Q, j, "Q", 1), 3, "Q", 2), get_base1(get_base1(ploidy, j, "ploidy", 1), i, "ploidy", 2), pstream__));
                }
            }
...
typedef model_Q_gl_mix_namespace::model_Q_gl_mix stan_model;
#ifndef USING_R
