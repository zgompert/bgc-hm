...
static constexpr std::array<const char*, 45> locations_array__ =
  ...
  " (in 'Q_mix', line 31, column 1 to column 17)",
  " (in 'Q_mix', line 46, column 1 to column 31)",
  " (in 'Q_mix', line 48, column 2 to column 33)",
  " (in 'Q_mix', line 47, column 14 to line 49, column 2)",
  " (in 'Q_mix', line 47, column 1 to line 49, column 2)",
  " (in 'Q_mix', line 37, column 3 to column 84)",
  " (in 'Q_mix', line 35, column 15 to line 38, column 3)",
  " (in 'Q_mix', line 35, column 2 to line 38, column 3)",
  " (in 'Q_mix', line 34, column 14 to line 39, column 2)",
  " (in 'Q_mix', line 34, column 1 to line 39, column 2)",
  " (in 'Q_mix', line 42, column 2 to column 54)",
  " (in 'Q_mix', line 40, column 14 to line 43, column 2)",
  " (in 'Q_mix', line 40, column 1 to line 43, column 2)",
  " (in 'Q_mix', line 23, column 1 to column 7)",
  " (in 'Q_mix', line 24, column 1 to column 7)",
  " (in 'Q_mix', line 25, column 25 to column 26)",
  " (in 'Q_mix', line 25, column 28 to column 29)",
  " (in 'Q_mix', line 25, column 1 to column 31)",
  " (in 'Q_mix', line 26, column 31 to column 32)",
  " (in 'Q_mix', line 26, column 34 to column 35)",
  " (in 'Q_mix', line 26, column 1 to column 37)",
  " (in 'Q_mix', line 27, column 26 to column 27)",
  " (in 'Q_mix', line 27, column 1 to column 32)",
  " (in 'Q_mix', line 28, column 26 to column 27)",
  " (in 'Q_mix', line 28, column 1 to column 32)",
  " (in 'Q_mix', line 31, column 14 to column 15)",
  " (in 'Q_mix', line 46, column 26 to column 27)",
  " (in 'Q_mix', line 3, column 2 to column 12)",
  " (in 'Q_mix', line 17, column 6 to column 13)",
  " (in 'Q_mix', line 16, column 11 to line 18, column 6)",
  ...
  " (in 'Q_mix', line 11, column 21 to line 16, column 6)",
  " (in 'Q_mix', line 11, column 12 to line 18, column 6)",
  ...
  " (in 'Q_mix', line 4, column 2 to line 18, column 6)",
  " (in 'Q_mix', line 19, column 2 to column 14)",
  " (in 'Q_mix', line 2, column 79 to line 20, column 2)"};
...
calc_lik(const T0__& g, const T1__& p0, const T2__& p1, const T3__& q11,
         const T4__& q10, const T5__& q00, const T6__& pl, std::ostream*
         pstream__);
template <typename T0__, typename T1__, typename T2__, typename T3__,
          typename T4__, typename T5__, typename T6__,
          stan::require_all_t<stan::is_stan_scalar<T0__>,
  ...
  try {
    ...
    if (stan::math::logical_eq(pl, 2)) {
      ...
      if (stan::math::logical_eq(g, 0)) {
        ...
        prob = stan::math::log(((((q11 * (1 - p1)) * (1 - p1)) + ((q00 * (1 -
                 p0)) * (1 - p0))) + ((q10 * (1 - p1)) * (1 - p0))));
      } else {
        current_statement__ = 38;
        if (stan::math::logical_eq(g, 1)) {
          current_statement__ = 37;
          prob = stan::math::log(((((((q11 * 2) * (1 - p0)) * p0) + (((q00 *
                   2) * (1 - p1)) * p1)) + ((q10 * (1 - p0)) * p1)) + ((q10 *
                   p0) * (1 - p1))));
        } else {
          current_statement__ = 36;
          prob = stan::math::log(((((q11 * p1) * p1) + ((q00 * p0) * p0)) +
                   ((q10 * p1) * p0)));
        }
      }
    } else {
      ...
      if (stan::math::logical_eq(pl, 1)) {
        ...
        if (stan::math::logical_eq(g, 0)) {
          ...
          prob = stan::math::log(((((q11 * (1 - p1)) + (q00 * (1 - p0))) +
                   ((0.5 * q10) * (1 - p1))) + ((0.5 * q10) * (1 - p0))));
        } else {
          current_statement__ = 31;
          prob = stan::math::log(((((q11 * p1) + (q00 * p0)) + ((0.5 * q10) *
                   p1)) + ((0.5 * q10) * p0)));
        }
      } else {
...
public:
  ~model_Q_mix() {}
  model_Q_mix(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_Q_mix_namespace::model_Q_mix";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_Q_mix_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_Q_mix_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
