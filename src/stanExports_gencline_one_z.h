...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'gencline_one_z', line 29, column 1 to column 38)",
                                                      " (in 'gencline_one_z', line 30, column 1 to column 28)",
                                                      " (in 'gencline_one_z', line 33, column 1 to column 31)",
                                                      " (in 'gencline_one_z', line 34, column 1 to column 23)",
                                                      " (in 'gencline_one_z', line 39, column 2 to column 39)",
                                                      " (in 'gencline_one_z', line 37, column 14 to line 40, column 2)",
                                                      " (in 'gencline_one_z', line 37, column 1 to line 40, column 2)",
                                                      " (in 'gencline_one_z', line 42, column 1 to column 46)",
                                                      " (in 'gencline_one_z', line 43, column 1 to column 41)",
                                                      " (in 'gencline_one_z', line 21, column 1 to column 7)",
                                                      " (in 'gencline_one_z', line 22, column 1 to column 7)",
                                                      " (in 'gencline_one_z', line 23, column 26 to column 27)",
                                                      " (in 'gencline_one_z', line 23, column 1 to column 29)",
                                                      " (in 'gencline_one_z', line 24, column 26 to column 27)",
                                                      " (in 'gencline_one_z', line 24, column 1 to column 31)",
                                                      " (in 'gencline_one_z', line 25, column 1 to column 18)",
                                                      " (in 'gencline_one_z', line 26, column 1 to column 18)",
                                                      " (in 'gencline_one_z', line 3, column 2 to column 11)",
                                                      " (in 'gencline_one_z', line 4, column 2 to column 43)",
                                                      " (in 'gencline_one_z', line 5, column 2 to column 13)",
                                                      " (in 'gencline_one_z', line 2, column 40 to line 6, column 2)",
                                                      " (in 'gencline_one_z', line 8, column 2 to column 12)",
                                                      " (in 'gencline_one_z', line 9, column 2 to column 11)",
                                                      " (in 'gencline_one_z', line 10, column 2 to column 28)",
                                                      " (in 'gencline_one_z', line 16, column 12 to column 39)",
                                                      " (in 'gencline_one_z', line 14, column 12 to column 50)",
                                                      " (in 'gencline_one_z', line 13, column 13 to line 16, column 39)",
                                                      " (in 'gencline_one_z', line 12, column 12 to column 43)",
                                                      " (in 'gencline_one_z', line 11, column 8 to line 16, column 39)",
                                                      " (in 'gencline_one_z', line 17, column 2 to column 14)",
                                                      " (in 'gencline_one_z', line 7, column 48 to line 18, column 2)"};
...
class model_gencline_one_z final : public model_base_crtp<model_gencline_one_z> {
private:
  int L;
  int N;
  std::vector<double> Z;
...
public:
  ...
  inline std::string model_name() const final { return "model_gencline_one_z"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_gencline_one_z_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      check_less_or_equal(function__, "u", u, 100);
      {
        ...
        for (int j = 1; j <= N; ++j) {
          ...
          lp_accum__.add(calc_lik(Z[(j - 1)], H[(j - 1)], v, u, pstream__));}
...
using stan_model = model_gencline_one_z_namespace::model_gencline_one_z;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_gencline_one_z_namespace::profiles__;
}
#endif
#endif
