...
public:
  ...
  model_hi(stan::io::var_context& context__, unsigned int random_seed__ = 0,
    ...
    // suppress unused var warning
    (void) base_rng__;
    static constexpr const char* function__ = "model_hi_namespace::model_hi";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    // suppress unused var warning
    (void) DUMMY_VAR__;
    static constexpr const char* function__ = "model_hi_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_hi_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
