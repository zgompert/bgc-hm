...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_p");
    reader.add_event(34, 32, "end", "model_p");
    return reader;
}
#include <stan_meta_header.hpp>
class model_p
  : public stan::model::model_base_crtp<model_p> {
private:
        int L;
        int N0;
        int N1;
...
public:
    model_p(stan::io::var_context& context__,
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N0; ++j) {
                    ...
                    lp_accum__.add(binomial_log(get_base1(get_base1(G0, j, "G0", 1), i, "G0", 2), 2, get_base1(P0, i, "P0", 1)));
                }
                current_statement_begin__ = 22;
                for (int j = 1; j <= N1; ++j) {
                    current_statement_begin__ = 24;
                    lp_accum__.add(binomial_log(get_base1(get_base1(G1, j, "G1", 1), i, "G1", 2), 2, get_base1(P1, i, "P1", 1)));
                }
            }
...
typedef model_p_namespace::model_p stan_model;
#ifndef USING_R
