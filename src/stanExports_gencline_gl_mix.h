...
namespace model_gencline_gl_mix_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 68> locations_array__ =
  {" (found before start of program)",
  " (in 'gencline_gl_mix', line 39, column 1 to column 43)",
  " (in 'gencline_gl_mix', line 40, column 1 to column 33)",
  " (in 'gencline_gl_mix', line 41, column 1 to column 18)",
  " (in 'gencline_gl_mix', line 42, column 1 to column 18)",
  " (in 'gencline_gl_mix', line 45, column 1 to column 36)",
  " (in 'gencline_gl_mix', line 67, column 1 to column 19)",
  " (in 'gencline_gl_mix', line 68, column 1 to column 19)",
  " (in 'gencline_gl_mix', line 47, column 2 to column 33)",
  " (in 'gencline_gl_mix', line 46, column 14 to line 48, column 2)",
  " (in 'gencline_gl_mix', line 46, column 1 to line 48, column 2)",
  " (in 'gencline_gl_mix', line 69, column 1 to column 25)",
  " (in 'gencline_gl_mix', line 70, column 1 to column 20)",
  " (in 'gencline_gl_mix', line 54, column 3 to column 97)",
  " (in 'gencline_gl_mix', line 52, column 15 to line 55, column 3)",
  " (in 'gencline_gl_mix', line 52, column 2 to line 55, column 3)",
  " (in 'gencline_gl_mix', line 51, column 14 to line 56, column 2)",
  " (in 'gencline_gl_mix', line 51, column 1 to line 56, column 2)",
  " (in 'gencline_gl_mix', line 59, column 2 to column 50)",
  " (in 'gencline_gl_mix', line 60, column 2 to column 45)",
  " (in 'gencline_gl_mix', line 57, column 16 to line 61, column 2)",
  " (in 'gencline_gl_mix', line 57, column 1 to line 61, column 2)",
  " (in 'gencline_gl_mix', line 63, column 1 to column 36)",
  " (in 'gencline_gl_mix', line 64, column 1 to column 36)",
  " (in 'gencline_gl_mix', line 27, column 1 to column 7)",
  " (in 'gencline_gl_mix', line 28, column 1 to column 7)",
  " (in 'gencline_gl_mix', line 29, column 28 to column 29)",
  " (in 'gencline_gl_mix', line 29, column 31 to column 32)",
  " (in 'gencline_gl_mix', line 29, column 1 to column 34)",
  " (in 'gencline_gl_mix', line 30, column 28 to column 29)",
  " (in 'gencline_gl_mix', line 30, column 31 to column 32)",
  " (in 'gencline_gl_mix', line 30, column 1 to column 34)",
  " (in 'gencline_gl_mix', line 31, column 28 to column 29)",
  " (in 'gencline_gl_mix', line 31, column 31 to column 32)",
  " (in 'gencline_gl_mix', line 31, column 1 to column 34)",
  " (in 'gencline_gl_mix', line 32, column 31 to column 32)",
  " (in 'gencline_gl_mix', line 32, column 34 to column 35)",
  " (in 'gencline_gl_mix', line 32, column 1 to column 37)",
  " (in 'gencline_gl_mix', line 33, column 26 to column 27)",
  " (in 'gencline_gl_mix', line 33, column 1 to column 31)",
  " (in 'gencline_gl_mix', line 34, column 26 to column 27)",
  " (in 'gencline_gl_mix', line 34, column 1 to column 32)",
  " (in 'gencline_gl_mix', line 35, column 26 to column 27)",
  " (in 'gencline_gl_mix', line 35, column 1 to column 32)",
  " (in 'gencline_gl_mix', line 36, column 8 to column 26)",
  " (in 'gencline_gl_mix', line 39, column 33 to column 34)",
  " (in 'gencline_gl_mix', line 40, column 28 to column 29)",
  " (in 'gencline_gl_mix', line 45, column 31 to column 32)",
  " (in 'gencline_gl_mix', line 3, column 2 to column 11)",
  " (in 'gencline_gl_mix', line 4, column 2 to column 43)",
  " (in 'gencline_gl_mix', line 5, column 2 to column 13)",
  " (in 'gencline_gl_mix', line 2, column 40 to line 6, column 2)",
  " (in 'gencline_gl_mix', line 9, column 2 to column 12)",
  " (in 'gencline_gl_mix', line 10, column 2 to column 11)",
  " (in 'gencline_gl_mix', line 11, column 2 to column 28)",
  " (in 'gencline_gl_mix', line 21, column 6 to column 15)",
  " (in 'gencline_gl_mix', line 20, column 8 to line 22, column 3)",
  " (in 'gencline_gl_mix', line 17, column 6 to column 61)",
  " (in 'gencline_gl_mix', line 19, column 16 to column 82)",
  " (in 'gencline_gl_mix', line 16, column 19 to line 20, column 3)",
  " (in 'gencline_gl_mix', line 16, column 9 to line 22, column 3)",
  " (in 'gencline_gl_mix', line 13, column 13 to column 107)",
  " (in 'gencline_gl_mix', line 14, column 13 to column 127)",
  " (in 'gencline_gl_mix', line 15, column 13 to column 110)",
  " (in 'gencline_gl_mix', line 12, column 11 to line 16, column 3)",
  " (in 'gencline_gl_mix', line 12, column 2 to line 22, column 3)",
  " (in 'gencline_gl_mix', line 23, column 2 to column 14)",
  " (in 'gencline_gl_mix', line 8, column 97 to line 24, column 2)"};
...
class model_gencline_gl_mix final : public model_base_crtp<model_gencline_gl_mix> {
private:
  int L;
  int N;
...
public:
  ~model_gencline_gl_mix() {}
  model_gencline_gl_mix(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_gencline_gl_mix_namespace::model_gencline_gl_mix";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
    ...
    num_params_r__ = L + L + 1 + 1;
  }
  inline std::string model_name() const final {
    return "model_gencline_gl_mix";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_gencline_gl_mix_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_gencline_gl_mix_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"center", "v", "sc", "sv"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"center\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(L) + "},\"block\":\"parameters\"},{\"name\":\"v\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(L) + "},\"block\":\"parameters\"},{\"name\":\"sc\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sv\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"u\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(L) + "},\"block\":\"transformed_parameters\"},{\"name\":\"sdc\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"sdv\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((L + L) + 1) + 1);
...
using stan_model = model_gencline_gl_mix_namespace::model_gencline_gl_mix;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_gencline_gl_mix_namespace::profiles__;
}
#endif
#endif
