...
static constexpr std::array<const char*, 48> locations_array__ =
  ...
  " (in 'Q_gl_mix', line 28, column 1 to column 17)",
  " (in 'Q_gl_mix', line 43, column 1 to column 31)",
  " (in 'Q_gl_mix', line 45, column 2 to column 33)",
  " (in 'Q_gl_mix', line 44, column 14 to line 46, column 2)",
  " (in 'Q_gl_mix', line 44, column 1 to line 46, column 2)",
  " (in 'Q_gl_mix', line 34, column 3 to column 106)",
  " (in 'Q_gl_mix', line 32, column 15 to line 35, column 3)",
  " (in 'Q_gl_mix', line 32, column 2 to line 35, column 3)",
  " (in 'Q_gl_mix', line 31, column 14 to line 36, column 2)",
  " (in 'Q_gl_mix', line 31, column 1 to line 36, column 2)",
  " (in 'Q_gl_mix', line 39, column 2 to column 54)",
  " (in 'Q_gl_mix', line 37, column 14 to line 40, column 2)",
  " (in 'Q_gl_mix', line 37, column 1 to line 40, column 2)",
  " (in 'Q_gl_mix', line 18, column 1 to column 7)",
  " (in 'Q_gl_mix', line 19, column 1 to column 7)",
  ...
  " (in 'Q_gl_mix', line 21, column 28 to column 29)",
  " (in 'Q_gl_mix', line 21, column 31 to column 32)",
  " (in 'Q_gl_mix', line 21, column 1 to column 34)",
  " (in 'Q_gl_mix', line 22, column 28 to column 29)",
  " (in 'Q_gl_mix', line 22, column 31 to column 32)",
  " (in 'Q_gl_mix', line 22, column 1 to column 34)",
  " (in 'Q_gl_mix', line 23, column 34 to column 35)",
  " (in 'Q_gl_mix', line 23, column 37 to column 38)",
  " (in 'Q_gl_mix', line 23, column 4 to column 40)",
  " (in 'Q_gl_mix', line 24, column 26 to column 27)",
  " (in 'Q_gl_mix', line 24, column 1 to column 32)",
  " (in 'Q_gl_mix', line 25, column 26 to column 27)",
  " (in 'Q_gl_mix', line 25, column 1 to column 32)",
  " (in 'Q_gl_mix', line 28, column 14 to column 15)",
  " (in 'Q_gl_mix', line 43, column 26 to column 27)",
  " (in 'Q_gl_mix', line 3, column 2 to column 12)",
  " (in 'Q_gl_mix', line 12, column 6 to column 13)",
  " (in 'Q_gl_mix', line 11, column 12 to line 13, column 7)",
  " (in 'Q_gl_mix', line 9, column 9 to column 102)",
  " (in 'Q_gl_mix', line 10, column 6 to column 101)",
  " (in 'Q_gl_mix', line 8, column 22 to line 11, column 7)",
  " (in 'Q_gl_mix', line 8, column 13 to line 13, column 7)",
  " (in 'Q_gl_mix', line 5, column 2 to column 95)",
  " (in 'Q_gl_mix', line 6, column 2 to column 130)",
  " (in 'Q_gl_mix', line 7, column 9 to column 97)",
  " (in 'Q_gl_mix', line 4, column 11 to line 8, column 7)",
  " (in 'Q_gl_mix', line 4, column 2 to line 13, column 7)",
  " (in 'Q_gl_mix', line 14, column 2 to column 14)",
  " (in 'Q_gl_mix', line 2, column 101 to line 15, column 2)"};
    ...
    if (stan::math::logical_eq(pl, 2)) {
      ...
      prob = stan::math::log_sum_exp(prob, (stan::math::log(gl1) +
               stan::math::log(((((((q11 * 2) * (1 - p0)) * p0) + (((q00 * 2)
                 * (1 - p1)) * p1)) + ((q10 * (1 - p0)) * p1)) + ((q10 * p0)
                 * (1 - p1))))));
      current_statement__ = 43;
      prob = stan::math::log_sum_exp(prob, (stan::math::log(gl2) +
               stan::math::log(((((q11 * p1) * p1) + ((q00 * p0) * p0)) +
                 ((q10 * p1) * p0)))));
    } else {
      ...
      if (stan::math::logical_eq(pl, 1)) {
        ...
        prob = (stan::math::log(gl0) +
          stan::math::log(((((q11 * (1 - p1)) + (q00 * (1 - p0))) + ((0.5 *
            q10) * (1 - p1))) + ((0.5 * q10) * (1 - p0)))));
        current_statement__ = 38;
        prob = stan::math::log_sum_exp(prob, (stan::math::log(gl1) +
                 stan::math::log(((((q11 * p1) + (q00 * p0)) + ((0.5 * q10) *
                   p1)) + ((0.5 * q10) * p0)))));
      } else {
...
public:
  ~model_Q_gl_mix() {}
  model_Q_gl_mix(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_Q_gl_mix_namespace::model_Q_gl_mix";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_Q_gl_mix_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_Q_gl_mix_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
