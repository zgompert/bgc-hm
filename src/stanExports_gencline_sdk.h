...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gencline_sdk");
    reader.add_event(61, 59, "end", "model_gencline_sdk");
    return reader;
}
...
class model_gencline_sdk
  : public stan::model::model_base_crtp<model_gencline_sdk> {
private:
        int L;
        int N;
...
typedef model_gencline_sdk_namespace::model_gencline_sdk stan_model;
#ifndef USING_R
