...
#include "stanExports_gencline_gl_mix_mu.h"

RCPP_MODULE(stan_fit4gencline_gl_mix_mu_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_gencline_gl_mix_mu")
