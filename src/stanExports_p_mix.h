...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_p_mix");
    reader.add_event(36, 34, "end", "model_p_mix");
    return reader;
}
#include <stan_meta_header.hpp>
class model_p_mix
  : public stan::model::model_base_crtp<model_p_mix> {
private:
        int L;
        int N0;
        int N1;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "G0", "int", context__.to_vec(N0,L));
            G0 = std::vector<std::vector<int> >(N0, std::vector<int>(L, int(0)));
            vals_i__ = context__.vals_i("G0");
            pos__ = 0;
            size_t G0_k_0_max__ = N0;
            size_t G0_k_1_max__ = L;
            for (size_t k_1__ = 0; k_1__ < G0_k_1_max__; ++k_1__) {
                for (size_t k_0__ = 0; k_0__ < G0_k_0_max__; ++k_0__) {
                    G0[k_0__][k_1__] = vals_i__[pos__++];
                }
            }
            size_t G0_i_0_max__ = N0;
            size_t G0_i_1_max__ = L;
            for (size_t i_0__ = 0; i_0__ < G0_i_0_max__; ++i_0__) {
                for (size_t i_1__ = 0; i_1__ < G0_i_1_max__; ++i_1__) {
                    ...
                    check_less_or_equal(function__, "G0[i_0__][i_1__]", G0[i_0__][i_1__], 2);
                }
            }
            current_statement_begin__ = 7;
            validate_non_negative_index("G1", "N1", N1);
            validate_non_negative_index("G1", "L", L);
            context__.validate_dims("data initialization", "G1", "int", context__.to_vec(N1,L));
            G1 = std::vector<std::vector<int> >(N1, std::vector<int>(L, int(0)));
            vals_i__ = context__.vals_i("G1");
            pos__ = 0;
            size_t G1_k_0_max__ = N1;
            size_t G1_k_1_max__ = L;
            for (size_t k_1__ = 0; k_1__ < G1_k_1_max__; ++k_1__) {
                for (size_t k_0__ = 0; k_0__ < G1_k_0_max__; ++k_0__) {
                    G1[k_0__][k_1__] = vals_i__[pos__++];
                }
            }
            size_t G1_i_0_max__ = N1;
            size_t G1_i_1_max__ = L;
            for (size_t i_0__ = 0; i_0__ < G1_i_0_max__; ++i_0__) {
                for (size_t i_1__ = 0; i_1__ < G1_i_1_max__; ++i_1__) {
                    check_greater_or_equal(function__, "G1[i_0__][i_1__]", G1[i_0__][i_1__], 0);
                    check_less_or_equal(function__, "G1[i_0__][i_1__]", G1[i_0__][i_1__], 2);
                }
            }
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N0; ++j) {
                    ...
                    lp_accum__.add(binomial_log(get_base1(get_base1(G0, j, "G0", 1), i, "G0", 2), get_base1(get_base1(ploidy0, j, "ploidy0", 1), i, "ploidy0", 2), get_base1(P0, i, "P0", 1)));
                }
                current_statement_begin__ = 24;
                for (int j = 1; j <= N1; ++j) {
                    current_statement_begin__ = 26;
                    lp_accum__.add(binomial_log(get_base1(get_base1(G1, j, "G1", 1), i, "G1", 2), get_base1(get_base1(ploidy1, j, "ploidy1", 1), i, "ploidy1", 2), get_base1(P1, i, "P1", 1)));
                }
            }
...
typedef model_p_mix_namespace::model_p_mix stan_model;
#ifndef USING_R
