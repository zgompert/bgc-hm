...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_hi_gl_mix");
    reader.add_event(46, 44, "end", "model_hi_gl_mix");
    return reader;
}
...
calc_lik(const T0__& gl0,
    ...
    try {
        ...
        if (as_bool(logical_eq(pl, 2))) {
            ...
            stan::math::assign(prob, ((stan::math::log(gl0) + stan::math::log(((h * (1 - p1)) + ((1 - h) * (1 - p0))))) + stan::math::log(((h * (1 - p1)) + ((1 - h) * (1 - p0))))));
            current_statement_begin__ = 6;
            stan::math::assign(prob, log_sum_exp(prob, (((stan::math::log(gl1) + stan::math::log(2)) + stan::math::log(((h * (1 - p1)) + ((1 - h) * (1 - p0))))) + stan::math::log(((h * p1) + ((1 - h) * p0))))));
            current_statement_begin__ = 7;
            stan::math::assign(prob, log_sum_exp(prob, (stan::math::log(((h * p1) + ((1 - h) * p0))) + stan::math::log(((h * p1) + ((1 - h) * p0))))));
        } else {
            current_statement_begin__ = 9;
            stan::math::assign(prob, (stan::math::log(gl0) + stan::math::log(((h * (1 - p1)) + ((1 - h) * (1 - p0))))));
            current_statement_begin__ = 10;
            stan::math::assign(prob, log_sum_exp(prob, (stan::math::log(gl2) + stan::math::log(((h * p1) + ((1 - h) * p0))))));
        }
...
class model_hi_gl_mix
  : public stan::model::model_base_crtp<model_hi_gl_mix> {
private:
        int L;
        int N;
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("H", "N", N);
        context__.validate_dims("parameter initialization", "H", "vector_d", context__.to_vec(N));
        ...
        try {
            writer__.vector_lub_unconstrain(0, 1, H);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                H = in__.vector_lub_constrain(0, 1, N, lp__);
            else
                H = in__.vector_lub_constrain(0, 1, N);
            // model body
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N; ++j) {
                    ...
                    lp_accum__.add(calc_lik(get_base1(get_base1(GL0, j, "GL0", 1), i, "GL0", 2), get_base1(get_base1(GL1, j, "GL1", 1), i, "GL1", 2), get_base1(get_base1(GL2, j, "GL2", 1), i, "GL2", 2), get_base1(P0, i, "P0", 1), get_base1(P1, i, "P1", 1), get_base1(H, j, "H", 1), get_base1(get_base1(ploidy, j, "ploidy", 1), i, "ploidy", 2), pstream__));
                }
            }
            current_statement_begin__ = 39;
            for (int j = 1; j <= N; ++j) {
                current_statement_begin__ = 41;
                lp_accum__.add(beta_log(get_base1(H, j, "H", 1), 0.5, 0.5));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> H = in__.vector_lub_constrain(0, 1, N);
        size_t H_j_1_max__ = N;
        for (size_t j_1__ = 0; j_1__ < H_j_1_max__; ++j_1__) {
...
typedef model_hi_gl_mix_namespace::model_hi_gl_mix stan_model;
#ifndef USING_R
