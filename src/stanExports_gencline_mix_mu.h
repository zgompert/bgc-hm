...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gencline_mix_mu");
    reader.add_event(89, 87, "end", "model_gencline_mix_mu");
    return reader;
}
    ...
    try {
        ...
        if (as_bool(logical_eq(pl, 2))) {
            ...
            if (as_bool(logical_eq(g, 0))) {
                ...
                stan::math::assign(prob, (stan::math::log(((phi * (1 - p1)) + ((1 - phi) * (1 - p0)))) + stan::math::log(((phi * (1 - p1)) + ((1 - phi) * (1 - p0))))));
            } else if (as_bool(logical_eq(g, 1))) {
                current_statement_begin__ = 15;
                stan::math::assign(prob, (stan::math::log(((phi * (1 - p1)) + ((1 - phi) * (1 - p0)))) + stan::math::log(((phi * p1) + ((1 - phi) * p0)))));
            } else {
                current_statement_begin__ = 17;
                stan::math::assign(prob, (stan::math::log(((phi * p1) + ((1 - phi) * p0))) + stan::math::log(((phi * p1) + ((1 - phi) * p0)))));
            }
        } else if (as_bool(logical_eq(pl, 1))) {
            current_statement_begin__ = 19;
            if (as_bool(logical_eq(g, 0))) {
                current_statement_begin__ = 20;
                stan::math::assign(prob, stan::math::log(((phi * (1 - p1)) + ((1 - phi) * (1 - p0)))));
            } else {
                current_statement_begin__ = 22;
                stan::math::assign(prob, stan::math::log(((phi * p1) + ((1 - phi) * p0))));
            }
        } else {
...
class model_gencline_mix_mu
  : public stan::model::model_base_crtp<model_gencline_mix_mu> {
private:
        int L;
        int N;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "G", "double", context__.to_vec(N,L));
            G = std::vector<std::vector<double> >(N, std::vector<double>(L, double(0)));
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N; ++j) {
                    ...
                    lp_accum__.add(calc_lik(get_base1(get_base1(G, j, "G", 1), i, "G", 2), get_base1(P0, i, "P0", 1), get_base1(P1, i, "P1", 1), get_base1(H, j, "H", 1), get_base1(v, i, "v", 1), get_base1(u, i, "u", 1), get_base1(get_base1(ploidy, j, "ploidy", 1), i, "ploidy", 2), pstream__));
                }
            }
...
typedef model_gencline_mix_mu_namespace::model_gencline_mix_mu stan_model;
#ifndef USING_R
