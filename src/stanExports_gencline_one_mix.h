...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'gencline_one_mix', line 39, column 1 to column 38)",
                                                      " (in 'gencline_one_mix', line 40, column 1 to column 28)",
                                                      " (in 'gencline_one_mix', line 43, column 1 to column 31)",
                                                      " (in 'gencline_one_mix', line 44, column 1 to column 23)",
                                                      " (in 'gencline_one_mix', line 49, column 2 to column 58)",
                                                      " (in 'gencline_one_mix', line 47, column 14 to line 50, column 2)",
                                                      " (in 'gencline_one_mix', line 47, column 1 to line 50, column 2)",
                                                      " (in 'gencline_one_mix', line 52, column 1 to column 46)",
                                                      " (in 'gencline_one_mix', line 53, column 1 to column 41)",
                                                      " (in 'gencline_one_mix', line 28, column 1 to column 7)",
                                                      " (in 'gencline_one_mix', line 29, column 1 to column 7)",
                                                      " (in 'gencline_one_mix', line 30, column 26 to column 27)",
                                                      " (in 'gencline_one_mix', line 30, column 1 to column 29)",
                                                      " (in 'gencline_one_mix', line 31, column 31 to column 32)",
                                                      " (in 'gencline_one_mix', line 31, column 1 to column 34)",
                                                      " (in 'gencline_one_mix', line 32, column 26 to column 27)",
                                                      " (in 'gencline_one_mix', line 32, column 1 to column 31)",
                                                      " (in 'gencline_one_mix', line 33, column 1 to column 27)",
                                                      " (in 'gencline_one_mix', line 34, column 1 to column 27)",
                                                      " (in 'gencline_one_mix', line 35, column 1 to column 18)",
                                                      " (in 'gencline_one_mix', line 36, column 1 to column 18)",
                                                      ...
                                                      " (in 'gencline_one_mix', line 22, column 15 to column 52)",
                                                      " (in 'gencline_one_mix', line 20, column 16 to column 60)",
                                                      " (in 'gencline_one_mix', line 19, column 12 to line 22, column 52)",
                                                      " (in 'gencline_one_mix', line 18, column 15 to line 23, column 9)",
                                                      " (in 'gencline_one_mix', line 17, column 16 to column 83)",
                                                      " (in 'gencline_one_mix', line 15, column 16 to column 91)",
                                                      " (in 'gencline_one_mix', line 14, column 17 to line 17, column 83)",
                                                      " (in 'gencline_one_mix', line 13, column 16 to column 99)",
                                                      " (in 'gencline_one_mix', line 12, column 12 to line 17, column 83)",
                                                      " (in 'gencline_one_mix', line 11, column 11 to line 18, column 9)",
                                                      " (in 'gencline_one_mix', line 11, column 2 to line 23, column 9)",
                                                      " (in 'gencline_one_mix', line 24, column 2 to column 14)",
                                                      " (in 'gencline_one_mix', line 7, column 75 to line 25, column 2)"};
...
public:
  ...
  inline std::string model_name() const final { return "model_gencline_one_mix"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_gencline_one_mix(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_gencline_one_mix_namespace::model_gencline_one_mix";
    ...
    try {
      ...
      for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
        current_statement__ = 13;
        current_statement__ = 13;
        check_less_or_equal(function__, "G[sym1__]", G[(sym1__ - 1)], 2);}
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_gencline_one_mix_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      check_less_or_equal(function__, "u", u, 100);
      {
        ...
        for (int j = 1; j <= N; ++j) {
          ...
          lp_accum__.add(
            calc_lik(G[(j - 1)], P0, P1, H[(j - 1)], v, u,
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_gencline_one_mix_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
