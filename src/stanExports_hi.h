...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_hi");
    reader.add_event(41, 39, "end", "model_hi");
    return reader;
}
...
calc_lik(const T0__& g,
             const T1__& p0,
             const T2__& p1,
             const T3__& h, std::ostream* pstream__) {
    ...
    try {
        ...
        if (as_bool(logical_eq(g, 0))) {
            ...
            stan::math::assign(prob, (stan::math::log(((h * (1 - p1)) + ((1 - h) * (1 - p0)))) + stan::math::log(((h * (1 - p1)) + ((1 - h) * (1 - p0))))));
        } else if (as_bool(logical_eq(g, 1))) {
            current_statement_begin__ = 7;
            stan::math::assign(prob, ((stan::math::log(2) + stan::math::log(((h * (1 - p1)) + ((1 - h) * (1 - p0))))) + stan::math::log(((h * p1) + ((1 - h) * p0)))));
        } else {
            current_statement_begin__ = 9;
            stan::math::assign(prob, (stan::math::log(((h * p1) + ((1 - h) * p0))) + stan::math::log(((h * p1) + ((1 - h) * p0)))));
        }
...
struct calc_lik_functor__ {
    ...
    operator()(const T0__& g,
             const T1__& p0,
             const T2__& p1,
             const T3__& h, std::ostream* pstream__) const {
        return calc_lik(g, p0, p1, h, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_hi
  : public stan::model::model_base_crtp<model_hi> {
private:
        int L;
        int N;
        ...
        vector_d P1;
public:
    model_hi(stan::io::var_context& context__,
        ...
        try {
            ...
            for (int i = 1; i <= L; ++i) {
                ...
                for (int j = 1; j <= N; ++j) {
                    ...
                    lp_accum__.add(calc_lik(get_base1(get_base1(G, j, "G", 1), i, "G", 2), get_base1(P0, i, "P0", 1), get_base1(P1, i, "P1", 1), get_base1(H, j, "H", 1), pstream__));
                }
            }
...
typedef model_hi_namespace::model_hi stan_model;
#ifndef USING_R
