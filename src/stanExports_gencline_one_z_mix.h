...
namespace model_gencline_one_z_mix_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'gencline_one_z_mix', line 37, column 1 to column 38)",
                                                      " (in 'gencline_one_z_mix', line 38, column 1 to column 28)",
                                                      " (in 'gencline_one_z_mix', line 41, column 1 to column 31)",
                                                      " (in 'gencline_one_z_mix', line 42, column 1 to column 23)",
                                                      " (in 'gencline_one_z_mix', line 47, column 2 to column 50)",
                                                      " (in 'gencline_one_z_mix', line 45, column 14 to line 48, column 2)",
                                                      " (in 'gencline_one_z_mix', line 45, column 1 to line 48, column 2)",
                                                      " (in 'gencline_one_z_mix', line 50, column 1 to column 46)",
                                                      " (in 'gencline_one_z_mix', line 51, column 1 to column 41)",
                                                      " (in 'gencline_one_z_mix', line 28, column 1 to column 7)",
                                                      " (in 'gencline_one_z_mix', line 29, column 1 to column 7)",
                                                      " (in 'gencline_one_z_mix', line 30, column 26 to column 27)",
                                                      " (in 'gencline_one_z_mix', line 30, column 1 to column 29)",
                                                      " (in 'gencline_one_z_mix', line 31, column 31 to column 32)",
                                                      " (in 'gencline_one_z_mix', line 31, column 1 to column 34)",
                                                      " (in 'gencline_one_z_mix', line 32, column 26 to column 27)",
                                                      " (in 'gencline_one_z_mix', line 32, column 1 to column 31)",
                                                      " (in 'gencline_one_z_mix', line 33, column 1 to column 18)",
                                                      " (in 'gencline_one_z_mix', line 34, column 1 to column 18)",
                                                      " (in 'gencline_one_z_mix', line 3, column 2 to column 11)",
                                                      " (in 'gencline_one_z_mix', line 4, column 2 to column 43)",
                                                      " (in 'gencline_one_z_mix', line 5, column 2 to column 13)",
                                                      " (in 'gencline_one_z_mix', line 2, column 40 to line 6, column 2)",
                                                      " (in 'gencline_one_z_mix', line 8, column 2 to column 12)",
                                                      " (in 'gencline_one_z_mix', line 9, column 2 to column 11)",
                                                      " (in 'gencline_one_z_mix', line 10, column 2 to column 28)",
                                                      " (in 'gencline_one_z_mix', line 22, column 15 to column 31)",
                                                      " (in 'gencline_one_z_mix', line 20, column 15 to column 33)",
                                                      " (in 'gencline_one_z_mix', line 19, column 3 to line 22, column 31)",
                                                      " (in 'gencline_one_z_mix', line 18, column 9 to line 23, column 14)",
                                                      " (in 'gencline_one_z_mix', line 17, column 15 to column 42)",
                                                      " (in 'gencline_one_z_mix', line 15, column 15 to column 53)",
                                                      " (in 'gencline_one_z_mix', line 14, column 15 to line 17, column 42)",
                                                      " (in 'gencline_one_z_mix', line 13, column 15 to column 46)",
                                                      " (in 'gencline_one_z_mix', line 12, column 10 to line 17, column 42)",
                                                      " (in 'gencline_one_z_mix', line 11, column 11 to line 18, column 3)",
                                                      " (in 'gencline_one_z_mix', line 11, column 2 to line 23, column 14)",
                                                      " (in 'gencline_one_z_mix', line 24, column 2 to column 14)",
                                                      " (in 'gencline_one_z_mix', line 7, column 57 to line 25, column 2)"};
...
class model_gencline_one_z_mix final : public model_base_crtp<model_gencline_one_z_mix> {
private:
  int L;
  int N;
  std::vector<double> Z;
...
public:
  ~model_gencline_one_z_mix() { }
  
  inline std::string model_name() const final { return "model_gencline_one_z_mix"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_gencline_one_z_mix(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_gencline_one_z_mix_namespace::model_gencline_one_z_mix";
    ...
    try {
      ...
      current_statement__ = 13;
      assign(Z, nil_index_list(), context__.vals_r("Z"),
      ...
      for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
        current_statement__ = 13;
        current_statement__ = 13;
        check_less_or_equal(function__, "Z[sym1__]", Z[(sym1__ - 1)], 2);}
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_gencline_one_z_mix_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_gencline_one_z_mix_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_gencline_one_z_mix_namespace::model_gencline_one_z_mix;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_gencline_one_z_mix_namespace::profiles__;
}
#endif
#endif
